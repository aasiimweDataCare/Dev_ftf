...
class Dashindicatorone_model extends CI_Model
{
    ...
    {
        $this->db->select("sum( if( `year` = '2013' and nameMSME <>'', 1,0 ) ) AS notrainedYr1,
                                sum( if( `year` = '2014' and nameMSME <>'', 1, 0 ) ) AS notrainedYr2,
                                sum( if( `year` = '2015' and nameMSME <>'', 1, 0 ) ) AS notrainedYr3,
                                sum( if( `year` = '2016' and nameMSME <>'', 1, 0 ) ) AS notrainedYr4,
                                sum( if( `year` = '2017' and nameMSME <>'', 1, 0 ) ) AS notrainedYr5,
                                sum( if( `year` = '2018' and nameMSME <>'', 1, 0 ) ) AS notrainedYr6
                                FROM `tbl_bankloans` ",FALSE);
