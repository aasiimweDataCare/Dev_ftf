...
class DashindicatorTwelve_model extends CI_Model
{
    ...
    function IndicatorTwelveRegion($region)
    {
		...
		sum(tbl_form4_traders.volMaizePurchased) as volMaizePurchased,
		sum(tbl_form4_traders.volBeansPurchased) as volBeansPurchased,
		sum(tbl_form4_traders.volCoffeePurchased) as volCoffeePurchased 
