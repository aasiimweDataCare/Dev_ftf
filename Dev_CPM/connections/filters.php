...
$data.="<option value=\"".$row['subcomponent']."\" >".$row['subcomponent_code']." ".$row['subcomponent']."</option>";
  ...
  <tr class='evenrow'>
	...
	$data.="<option value=''>-All-</option>";
	$query1=mysql_query("select * from tbl_output WHERE subcomp_id like '".$_SESSION['usersubcomponent']."%' order by output_code asc") or die("aBi Error-code 499 because, ".mysql_error());
	while($row1=mysql_fetch_array($query1)){
  ...
  <tr class='evenrow'>
	...
	$data.="<option value=''>-All-</option>";
	$query1=mysql_query("select * from tbl_activity WHERE subcomp_id like '".$_SESSION['usersubcomponent']."%' order by activity_code asc") or die("aBi Error-code 499 because, ".mysql_error());
	while($row1=mysql_fetch_array($query1)){
...
<tr class='evenrow'>
    <td scope='col' colspan=2><B>Subactivity:</b></td><td scope='col' colspan=5><select name='subactivity' id='subactivity'><option value=''>-All-</option>";
	/* if($_SESSION['ccfsubactivity']!='')$data.="<option value='".$_SESSION['ccfsubactivity']."'>".substr($_SESSION['ccfsubactivity'],0,70)."</option>";
	else
	$data.=""; */
	$query1=mysql_query("select * from tbl_subactivity WHERE subcomponent_id like '".$_SESSION['usersubcomponent']."%' order by subactivity_code asc") or die("aBi Error-code 499 because, ".mysql_error());
	while($row1=mysql_fetch_array($query1)){
...
<tr class='evenrow'>
  ...
  <tr class='evenrow'>
 <td COLSPAN='2'><strong>Semi-Annual:</strong></td><td COLSPAN=''><select name='half_year' id='half_year' ><option value=''>-All-</option>";
...
<th scope='col' colspan='2'>Programme</th><th colspan=3>
	  ...
	  $query=mysql_query("select * from tbl_programme order by prog_id asc")or die(mysql_error());
	  while($row=mysql_fetch_array($query)){
...
if($_SESSION['usersubcomponent']<>''){
  $query2=mysql_query("select * from tbl_subcomponent where id='".$_SESSION['usersubcomponent']."'  order by id desc")or die(mysql_error());
...
$data.="<option value='' />-All-</option>";
	  ...
	  $query2=mysql_query("select * from tbl_subcomponent  order by id desc")or die(mysql_error());
	  while($row2=mysql_fetch_array($query2)){
	 $selsubcomponent=($_SESSION['subcomponent100']==$row2['subcomponent'])?"SELECTED":"";
  ...
  <tr>
    ...
    <th scope='col' colspan='2'>Output</th><th colspan=2>
	  ...
	  $query=mysql_query("select * from tbl_output where subcomp_id like '".$_SESSION['usersubcomponent']."%' order by output_code asc")or die(mysql_error());
...
if($_SESSION['usersubcomponent']<>''){
 $query2s=mysql_query("select * from tbl_subcomponent where id='".$_SESSION['usersubcomponent']."'  order by subcomponent_code desc")or die(mysql_error());
  ...
  <tr class=evenrow>
    ...
    <td><label>
	 ...
	 $data.="<option value='".$_SESSION['username1']."'>".$_SESSION['username1']."</option>";
	  ...
	  $query=mysql_query("select * from view_login group by username order by username asc")or die(mysql_error());
  while($row=mysql_fetch_array($query)){
	...
	if($_SESSION['status']!='')
	 $data.="<option value='".$_SESSION['status']."'>".$_SESSION['status']."</option>";
	  ...
	  $query=mysql_query("select * from view_login group by status order by status asc")or die(mysql_error());
  while($row=mysql_fetch_array($query)){
...
$data=" 
		 <tr class=''>
              <td colspan='4' class='green_field'><div style='float:left;'>Planning &raquo; Results Based Project Life Targets
		...
		<tr class=evenrow2>
              ...
              <td colspan='3'><select name='programme' id='programme'>
                <option value=''>-All-</option>";
				$q=mysql_query("select * from tbl_programme order by prog_id asc")or die("aBi Error-code:264 because, ".mysql_error());
		...
		<tr class=evenrow>
              <td colspan=''>Sub-component:
                <label></label></td>
              <td colspan='2'><select name='subcomponent' id='subcomponent' >";
			  if($_SESSION['usersubcomponent']<>'') {
...
$selected2=($_SESSION['subcomponent104']==$rowsc['subcomponent'])?"SELECTED":"";
$data.="<option value=\"".$rowsc['subcomponent']."\" ".$selected2." >".$rowsc['subcomponent_code']." ".$rowsc['subcomponent']."</option>";
				
					  }  
					  
					  }
					  
$data.="</select></td><td><input name='search' type='button' value='Go' onclick=\"xajax_view_activityBasedPlanning('Results Based',getElementById('programme').value,getElementById('subcomponent').value)\" /></td>
        </tr>
";
            ...
            <tr class='evenrow'>
              ...
              <td colspan='4' class='evenrow'><div align='center'><strong> Results Based Project Life Targets</strong></div></td>
            </tr>
            <tr class=evenrow2>
			<td width='50' class='evenrow2' colspan=>Select</td>
			  <td colspan='' class='evenrow2' >Subcomponent</td>
...
$data.="<option value=''>-All-</option>"; 
$query=mysql_query("select * from tbl_activity where subcomp_id like '".$_SESSION['usersubcomponent']."%' order by activity_code asc")or die(mysql_error());
while($row=mysql_fetch_array($query)){
...
$data.="<option value=''>-All-</option>"; 
$query=mysql_query("select * from tbl_subactivity where subcomponent_id like '".$_SESSION['usersubcomponent']."%'  order by subactivity_code asc")or die(mysql_error());
while($row=mysql_fetch_array($query)){
...
$data.="<option value=''>-All-</option>"; 
$query=mysql_query("select * from tbl_indicator where subcomponent_id like '".$_SESSION['usersubcomponent']."%'  group by indicator_name order by indicator_name asc")or die(mysql_error());
while($row=mysql_fetch_array($query)){
...
$data=" 
		 <tr class=''>
           ...
           <select name='programme' id='programme' onchange=\"xajax_ABTrustBasedIndicatorPlanning('abi trust',getElementById('programme').value)\">
                <option value=''>-All-</option>";
				$q=mysql_query("select * from tbl_programme order by prog_id asc")or die("aBi Error-code:197 because, ".mysql_error());
				while($row=mysql_fetch_array($q)){
...
$end--;} while ($end>= 2010);
    ...
    $query=mysql_query("select * from tbl_indicator where subcomponent_id=3 group by indicator_name order by indicator_id asc ")or die(mysql_error());
      while($row=mysql_fetch_array($query)){
...
$end--;} while ($end>= 2010);
 ...
 /* $query=mysql_query("select * from tbl_organizationreporting group by year order by reportingPeriod")or die(mysql_error());
 ...
 */
    ...
    <td class='evenrow' colspan='7'><label>
	  ...
	  $query=mysql_query("select * from tbl_quarters group by quarterName order by quarterCode")or die(mysql_error());
	  while($row2=mysql_fetch_array($query)){
	  $data.="<option value='".$row2['quarterName']."'>".$row2['quarterName']."</option>";
	  }
      $data.="</select>
...
$end--;} while ($end>= 2010);
    ...
    <td class=evenrow><label>
      <input type='button' name='search' value='Go' onclick=\"xajax_view_valueChainDevelopment('".$_SESSION['managerorg_code']."','".$_SESSION['orgName']."',getElementById('year').value,getElementById('quarter').value,getElementById('indicator').value,'".$_SESSION['ReportingPeriod']."')\" />
    </label></td>
    <td class=evenrow></td>
  </tr>
  <tr>
...
$data=" <tr class='evenrow'>
    <td width='' scope='col' colspan='2'>Year</td>
    <td scope='col' colspan='2'><div align='left'  >Reporting Period </div>      <label> </label></td>
    <td width='=' scope='col' colspan='7' ><div align='left'>Indicator</div>      <label></label></td><td width='100'><input type='button' name='Submit' value='New Entry' onclick=\"xajax_new_DCEDvalueChainDevelopment('','','','','".$_SESSION['orgName']."','".$orgcode."','".$_SESSION['reportingPeriod']."')\" /></td><td width='74'><a href='export_to_excel_word.php?linkvar=Export Results Indicators&&subcomponent=".$subcomponent."&&org_code=".$org_code."&&orgname=".$orgname."&&year=".$_SESSION['year106']."&&quarter=".$quarter."&&indicator=".$_SESSION['indicator106']."&&format=excel'><input type='button' name='export' value='Export to Excel' />
    </a></td>
  </tr>
...
$end--;} while ($end>= 2010);
    ...
    <td class=evenrow colspan='2'><select name='abi_category' id='abi_category'>
      <option value=''>-ALL-</option>";
      $query1=mysql_query("select * from tbl_indicator where abitrust_category <> ''  group by abitrust_category order by abitrust_category asc")or die("aBi Error-code 934 because, ".mysql_error());
      while($row1=mysql_fetch_array($query1)){
	...
	$query=mysql_query("select * from view_organizationreporting where indicator_type like 'aBi Trust%' group by indicator_name order by indicator_id asc ")or die(mysql_error());
      while($row=mysql_fetch_array($query)){
	   $selected=$_SESSION['indicator106']==$row['indicator_name']?"SELECTED":"";
      $data.="<option value='".$row['indicator_name']."'  '".$selected."' >".substr($row['indicator_name'],0,50)."</option>";
      }
...
$data="<tr class='evenrow'>
   ...
   <div style='float:left;'>Subcomponent
	  ...
	  /* if($_SESSION['subcomponent1']!='')$data.="<option value='".$_SESSION['subcomponent1']."'>".$_SESSION['subcomponent1']."</option>";
		  ...
		  $q=mysql_query("select * from tbl_subcomponent order by id asc")or die(mysql_error());
		  while($row=mysql_fetch_array($q)){
...
$data="<table width='100%' border='0'>
  ...
  while($row=mysql_fetch_array($query)){
    ...
    <td><div align='left'>
      ...
      <select name=cname id='cname'>
		...
		$q=mysql_query("select * from tbl_lineofcredit where client_name <>'' order by client_name asc ")or die(mysql_error());
		while($row=mysql_fetch_array($q)){
  ...
  $data.="<tr class='evenrow'>
	...
	$query=mysql_query("select * from tbl_lineofcredit where loanPurpose <>'' order by loanPurpose asc")or die(mysql_error());
	while($row=mysql_fetch_array($query)){
	$data.="
 ...
 <tr>
   ...
   <tr>
    <th><div align='left'>
      <select name='branch' id='branch'>
        <option value='%'>-All-</option>
        ";
	 $query5=mysql_query("select * from tbl_branch order by branch_name asc ")or die(mysql_error());
  ...
  $data.="
	...
	<th><div align='left'><select name='location' id='location'><option value='%'>-All-</option>
        ";
	 $query7=mysql_query("select * from tbl_district order by districtName asc ")or die(mysql_error());
  ...
  $data.="
   ...
   <tr>
	...
	<th><div align='left'><select name='org_name' id='org_name'><option value='%'>-All-</option>";
	 $query6=mysql_query("select * from tbl_organization where orgName <> '' order by orgName asc ")or die(mysql_error());
  ...
  <tr>
    ...
    <th colspan=3 align='left'>
      <select name='subactivity_code'>
        ";
	$query=mysql_query("select * from tbl_subactivity group by subactivity_code order by subactivity_code asc")or die(mysql_error());
	while($row=mysql_fetch_array($query)){
	$data.="
...
<tr><td class='green_field'  colspan=3>Program Monitoring &raquo; ".$_SESSION['titlesubcomponent']." &raquo; New MOU  (".$_SESSION['orgName'].")</td>
  ...
  <tr class=evenrow>
	...
	$query=mysql_query("select * from tbl_mou group by loan_agreement order by loan_agreement asc")or die(mysql_error());
	while($row=mysql_fetch_array($query)){
...
$data="<table width='660' border='0'>
  ...
  <tr>
    <th scope='col'><div align='left'>
      <select name='fyr'>
        <option value='%'>-All-</option>";
         $query=mysql_query("select * from tbl_expenditure group by financial_year order by financial_year  asc")or die(mysql_error());
		     while($row=mysql_fetch_array($query)){
      ...
      <select name='quarter'>
        ...
        <option value='%'>-All-</option>
        ";
         $query=mysql_query("select * from tbl_expenditure group by quarter order by quarter asc")or die(mysql_error());
		     while($row=mysql_fetch_array($query)){
      ...
      <select name='enterprize'>
        <option value='%'>-All-</option>";
         $query=mysql_query("select * from tbl_organization group by orgName order by orgName asc")or die(mysql_error());
		     while($row=mysql_fetch_array($query)){
			 $data.="<option value='".$row['orgName']."'>".substr($row['orgName'],0,30)."</option>";
...
/* <tr class=evenrow style='display:none;'>
            ...
            $data.="<tr class=evenrow2 >
			  ...
			  /*   if($_SESSION['wpsubcomponent_id']!=''){
 $query=mysql_query("select * from view_activity where subcomp like '".$_SESSION['wpsubcomponent']."' order by activity_code asc")or die(mysql_error());
					  while($row=mysql_fetch_array($query)){
...
$data.="
<tr>
    <td scope='col' class=green_field colspan=8><div style='flaot:left;' >Planning &raquo; View Physical Annual Targets </div></td>
    <td width='186' scope='col' colspan=5><label>
      <div style='float:right;'>";
	  $new_entry=($_SESSION['role']<>'Monitoring and Evaluation')?"":" <input type='button' name='Submit' value='New Annual Targets' onclick=\"xajax_new_annualTarget('".$activity."','','')\"/>";
	  
       $data.=$new_entry."<a href='export_to_excel_word.php?linkvar=Export_Annual_Sub-Activity_Based_Workplan&&indicator_type=".$_SESSION['indicator_type']."&&subcomponent=".$_SESSION['wpsubcomponent']."&&output=".$_SESSION['outputAnnualplanning']."&&activity=".$_SESSION['activityAnnualplanning']."&&subactivity=".$_SESSION['subactivityAnnualplanning']."&&year=".$_SESSION['year']."&&format=excel'><input type='button' name='export' value='Export to Excel' />
    </a>
		 ...
		 <tr class='evenrow2'>
  <tr>
              <td colspan='13' align=left><hr align=left width=''/></td></tr>";
			  
			  
  $data.="<tr class='evenrow'>
    <td colspan=4><div align='left'>Annual Planning Category </div></td>
    <td class='' colspan=9>
      <select name='project_lifeplanning' id='project_lifeplanning' onChange=\"xajax_switchPlanningTypeAnnual(getElementById('project_lifeplanning').value);return false;\">
		...
		$query=mysql_query("select indicator_type from tbl_indicator where indicator_type like '".$_SESSION['indicator_type']."' group by indicator_type order by indicator_type asc ")or die(mysql_error());
		while($row=mysql_fetch_array($query)){
		$selplanning_type=($_SESSION['indicator_type']==$row['indicator_type'])?"SELECTED":"";
        $data.="<option value=\"".$row['indicator_type']."\" ".$$selplanning_type." >".$row['indicator_type']."</option>";
        }
      $data."</select>
    </label></td>
		...
		/*  $data.="<tr class='evenrow'>
			  ...
			  onchange=\"xajax_reload_annualTarget(getElementById('subcomponent').value
			  
			  
			  if($_SESSION['wpsubcomponent']!='')
$data.="<option value='".$_SESSION['wpsubcomponent']."'>".$_SESSION['wpsubcomponent_code']." ".$_SESSION['wpsubcomponent']."</option>";

else
//$data.="<option value=''>-All-</option>"; 
/$query1=mysql_query("select * from tbl_subcomponent order by subcomponent_code asc")or die(mysql_error());
while($row1=mysql_fetch_array($query1)){
$data.="<option value='".$row1['subcomponent']."'>".$row1['subcomponent_code']." ".$row1['subcomponent']."</option>";
...
//$data.="</select></td>
		 ...
		 $data.="<tr class='evenrow'>
			  ...
			  if($_SESSION['usersubcomponent']<>''){
			  $querysubcomp=mysql_query("select * from tbl_subcomponent where id='".$_SESSION['usersubcomponent']."' order by subcomponent_code asc")or die(mysql_error());
while($rowsub=mysql_fetch_array($querysubcomp)){
#$selsubcomp=($_SESSION['wpsubcomponent']==$row1['subcomponent'])?"SELECTED":"";
$data.="<option value=\"".$rowsub['subcomponent']."\" ".$selsubcomp.">".$rowsub['subcomponent_code']." ".$rowsub['subcomponent']."</option>";
}
}
else{
$data.="<option value=''>-All-</option>"; 
...
<tr class=evenrow>
              <td colspan='4'>Outputs
                <label></label></td>
              <td colspan='9'><select name='output' id='output' ><option value=''>-All-</option>";
			     if($_SESSION['wpsubcomponent']!=''){
					  $query=mysql_query("select * from view_output where lower(subcomponent) like '".$_SESSION['wpsubcomponent_id']."%' order by output_code asc")or die(mysql_error());
					  while($row=mysql_fetch_array($query)){
					  //$selected=($_SESSION['ou'])
					  $data.="<option value='".$row['output_name']."'>".$row['output_code']." ".$row['output_name']."</option>";
					  }
					  }
					  else 
					  $data.="<option value=''>-All-</option>";
            ...
            <tr class=evenrow>
              ...
              <td colspan='9'><select name='activity' id='activity'><option value=''>-All-</option>";
			    if($_SESSION['wpsubcomponent']!=''){
					  $query=mysql_query("select * from view_activity where lower(subcomponent) like '".$_SESSION['wpsubcomponent']."%' order by activity_code asc")or die(mysql_error());
					  while($row=mysql_fetch_array($query)){
...
$data.="<option value='".$row['activity_name']."' '".$selected."'>".$row['activity_code']." ".$row['activity_name']."</option>";
					  ...
					  $data.="<option value=''>-All-</option>";
					  $query=mysql_query("select * from view_activity where subcomponent_id like '".$_SESSION['usersubcomponent']."%'  order by activity_code asc")or die(mysql_error());
					  while($row=mysql_fetch_array($query)){
					  $selected=($_SESSION['activityAnnualplanning']==$row['activity_name'])?"selected":"";
$data.="<option value=\"".$row['activity_name']."\" ".$selected.">".$row['activity_code']." ".$row['activity_name']."</option>";
...
$data.="</select></td>
			...
			$data.="<tr class=evenrow>
              ...
              <td colspan='9'><select name='subactivity' id='subactivity'><option value=''>-All-</option>";
			    if($_SESSION['wpsubcomponent']!=''){
					  $query=mysql_query("select * from view_subactivity where lower(subcomponent) like '".$_SESSION['wpsubcomponent']."%' order by subactivity_code asc")or die(mysql_error());
					  while($row=mysql_fetch_array($query)){
...
$data.="<option value='".$row['subactivity_name']."' '".$sel."'>".$row['subactivity_code']." ".substr($row['subactivity_name'],0,50)."</option>";
					  ...
					  $data.="<option value=''>-All-</option>";
					  $query=mysql_query("select * from view_subactivity where subcomponent_id like '".$_SESSION['usersubcomponent']."%'  order by subactivity_code asc")or die(mysql_error());
					  while($row=mysql_fetch_array($query)){
  $sel=($_SESSION['subactivityAnnualplanning']==$row['subactivity_name'])?"SELECTED":"";
$data.="<option value=\"".$row['subactivity_name']."\" ".$sel." >".$row['subactivity_code']." ".substr($row['subactivity_name'],0,50)."</option>";
...
$end--;} while ($end>= 2010);
              $data.="</select>
              </select></td><td><input name='search' type='button' value='Go' onclick=\"xajax_view_annualTarget('Sub-Activity Based',getElementById('subcomponent').value,getElementById('output').value,getElementById('activity').value,getElementById('subactivity').value,getElementById('year').value)\" /></td>
            </tr>
";
...
";
  ...
  $data.="<tr   class='evenrow'>
			  ...
			  if($_SESSION['usersubcomponent']!=''){
$query1=mysql_query("select * from tbl_subcomponent where id='".$_SESSION['usersubcomponent']."' order by subcomponent_code asc")or die(mysql_error());
while($row1=mysql_fetch_array($query1)){
#$sel=($_SESSION['wpsubcomponent']==$row1['subcomponent'])?"SELECTED":"";
$data.="<option value=\"".$row1['subcomponent']."\" ".$sel." >".$row1['subcomponent_code']." ".$row1['subcomponent']."</option>";
...
$data.="<option value=''>-All-</option>"; 
$queryrc=mysql_query("select * from tbl_resultschain order by name asc")or die(mysql_error());
...
<tr class=evenrow>
              ...
              <td colspan='9'><select name='subsector' id='subsector' ><option value=''>-All-</option>";
					  ...
					  $querysc=mysql_query("select * from tbl_subsector  order by subsector asc")or die(mysql_error());
					  while($rowsc=mysql_fetch_array($querysc)){
...
<tr class='evenrow'>
	...
	/*   $new_entry=($_SESSION['role']<>'Monitoring and Evaluation')?"":"<input type='button' name='button' value='New DCED Annual Targets' onclick=\"xajax_new_DCEDQuantitativeannualTarget('','','','');return false;\" /> |"; */
       ...
       $data.="<a href='export_to_excel_word.php?linkvar=Export DCED Quantitative Annual Target&&subcomponent=".$_SESSION['wpsubcomponent']."&&intervention=".$_SESSION['intervention']."&&resultcahin=".$_SESSION['resultchain']."&&subsector=".$_SESSION['subsector']."&&year=".$_SESSION['fyear']."&&format=excel'><input type='button' name='export' value='Export to Excel' />
    </a>
...
$end--;} while ($end>= 2010);
              $data.="</select>
              </select></td><td><input name='search' type='button' value='Go' onclick=\"xajax_view_DCEDQuantitativeannualTargetReport(getElementById('subcomponent').value,getElementById('rchain').value,getElementById('subsector').value,getElementById('intervention').value,getElementById('year').value)\" /></td>
            </tr>
";
...
<tr>
  ...
  <tr class='evenrow'>
    ...
    <td colspan='7'><label>
      <select name='project_lifeplanning' id='project_lifeplanning' onChange=\"xajax_switchPlanningTypeAnnual(getElementById('project_lifeplanning').value);return false;\">
        <option value=''>-Select-</option>";
		$query=mysql_query("select indicator_type from tbl_indicator group by indicator_type order by indicator_type asc")or die(mysql_error());
		while($row=mysql_fetch_array($query)){
...
$data.="</select></td>
              ...
              <td colspan='6'><select name='indicator' id='indicator'><option value=''>-All-</option>";
			    //if($_SESSION['wpsubcomponent_id']!='')
					  $query12=mysql_query("select * from view_annualtarget where lower(indicator_type) like 'results based%' group by indicator_name order by indicator_name asc")or die("aBi Error-code  1647 because, ".mysql_error());
...
<tr class=evenrow>
              ...
              <td colspan='12'><select name='indicator' id='indicator'><option value=''>-All-</option>";
			    //if($_SESSION['wpsubcomponent_id']!='');
					  $query12=mysql_query("select * from view_annualtarget where lower(indicator_type) like 'result based%' group by indicator_name order by indicator_name asc")or die("aBi Error-code  1647 because, ".mysql_error());
					  while($row=mysql_fetch_array($query12)){
 $sel=($row['indicator_name']==$_SESSION['indicator_12'])?"SELECTED":"";
$data.="<option value='".$row['indicator_name']."' '".$sel."'>".substr($row['indicator_name'],0,50)."</option>";
  ...
  <tr class='evenrow'>
   ...
   <td colspan=2>Subsector:</td>
    <td colspan='2'>
	  ...
	  $queryrc=mysql_query('select * from tbl_subsector') or die("abi error-code 2361 because, ".mysql_error());
	  while($rowrc=mysql_fetch_array($queryrc)){
...
$data.="</select></td>
    <td width='31'><input type='button' name='button3' id='' value='Go' onclick=\"xajax_view_DCEDQualitativeannualTargetReport(getElementById('year').value,getElementById('timeline').value,getElementById('subsector').value,getElementById('status').value,getElementById('intervention').value,getElementById('indicator').value,getElementById('subcomponent').value,getElementById('rchain').value);return false;\" /></td>
  </tr>";
...
<tr class='evenrow'>
    <td colspan=2 >Subcomponent:</td>
    <td colspan='10'><select name='subcomponent' id='subcomponent'><option value=''>-ALL-</option>";
	  $queryn=mysql_query("select * from tbl_subcomponent where id='".$_SESSION['usersubcomponent']."' order by id asc") or die(http(2289));
	  while($rowintervn=mysql_fetch_array($queryn)){
...
$data="
  ...
  <select name='results_chain' id='results_chain'><option value=''>-All-</option>";
	$query=mysql_query("select * from tbl_resultschain order by rc_id asc")or die(mysql_error());
	while($row=mysql_fetch_array($query)){
...
$data="
  ...
  <tr>
    <th width='141'><div align='right'>Sub-sector</div></th>
    <th width='' colspan=2><select name='subsector' id='subsector'>";
if($_SESSION['subsector']!='')
	$data.="<option value='".$_SESSION['subsector']."'>".$_SESSION['subsector']."</option>";
	else 
	$data.="<option value=''>-All-</option>";
      $query=mysql_query("select * from tbl_subsector  order by subsector_id asc")or die("aBi error-code 1371 because, ".mysql_error());
	  while($row=mysql_fetch_array($query)){
	 /*  $sel=($_SESSION['subsector']==$row['subsector'])?"SELECTED":"";
	  #$selected=($_SESSION['subsector']==$row['subsector'])?"SELECTED":"";'".$sel."' */
	  $data.="<option value='".$row['subsector']."%' >".$row['subsector']."</option>";
	  
	  }
	  $data.="</select>  
   <input type='button' name='button' id='button' value='Go' onclick=\"xajax_view_subsector(getElementById('subsector').value)\"></th>
   
    <th width='76'><input type='button' name='add_intervention' id='button2' onclick=\"xajax_add_subsector()\" value='New Subsector'></th> <th width='100'><a href='export_to_excel_word.php?linkvar=Export Subsector&&subsector=".$_SESSION['subsector']."&&format=excel'><input type='button' name='export' value='Export to Excel' />
    </a></th>
  </tr>
";
return $data;
...
$data="
  ...
  <table>
  <tr class='evenrow'>
    <td width='' colspan=6><div style='float:left;'>Intervention:</div><div style='float:right;'>
   <select name='intervention' id='intervention'>";
if($_SESSION['intervention']!='')
	$data.="<option value='".$_SESSION['intervention']."'>".substr($_SESSION['intervention'],0,40)."</option>";
	else 
	$data.="<option value=''>-All-</option>";
      $query=mysql_query("select * from tbl_intervention  order by intervention_id asc")or die("aBi error-code 1371 because, ".mysql_error());
	  while($row=mysql_fetch_array($query)){
	 /*  $sel=($_SESSION['subsector']==$row['subsector'])?"SELECTED":"";
	  #$selected=($_SESSION['subsector']==$row['subsector'])?"SELECTED":"";'".$sel."' */
	  $data.="<option value='".$row['intervention']."%' >".substr($row['intervention'],0,40)."</option>";
	  
	  }
	  $data.="</select>  
   <input type='button' name='button' id='button' value='Go' onclick=\"xajax_view_intervention(getElementById('intervention').value)\"> |<input type='button' name='add_intervention' id='button2' onclick=\"xajax_add_intervention()\" value='New intervention'>  | <a href='export_to_excel_word.php?linkvar=Export Intervention&&intervention=".$_SESSION['intervention']."&&format=excel'><input type='button' name='export' value='Export to Excel' />
    </a></div></td>
  </tr>
";
return $data;
...
$data="<tr>
    ...
    <th width='' scope='col' colspan=2><div align='left'>User:
	  ...
	  $data.="<option value=''>-All-</option>";
	  $query1=mysql_query("select u.user_id,c.user_id,u.username from tbl_comment c inner join tbl_user u on(u.user_id=c.user_id) order by u.username asc")or die("aBi error-code 1962 because, ".mysql_error());
...
//$dataentry=($_SESSION['role']=='Managing Director'or'Chief Technical Advisor')?"":"<input type='button' name='newentry' value='Add Organization' onclick=\"xajax_new_organization();return false;\">";
$tot=mysql_fetch_array(mysql_query("select count(*) as num_org from tbl_organization where orgName <> ''"))or die(mysql_error()); 
$data.="<tr class='evenrow'>
        <td class='evenrow' colspan='11'><div style='float:left;'><b class='greenlinks'>TOTAL OF : ".$tot['num_org']." ORGANIZATIONS</b></div><div style='float:right;'><a href='export_to_excel_word.php?linkvar=Export Organization&&districtName=".$_SESSION['district1']."&orgName=".$_SESSION['orgname1']."&&orgtype=".$_SESSION['orgtype1']."&&subcomponent=".$_SESSION['subcomponentorg']."&&subsector=".$_SESSION['subsectororg']."&&format=word'><input name='export' type='button' value='Export to Excel' /></a> | ";
		if($_SESSION['role']=='Managing Director')
		$data.="";
		else if($_SESSION['role']=='Chief Technical Advisor')
		$data.="";
		...
		<tr class='evenrow'>
        <td width='' colspan='3' class=''><strong>Subcomponent:</strong></td> <td width='' class='evenrow' colspan='3' ><select name='subcomponent' size='1' class='' id='subcomponent'>
          <option value=''>-All-</option>
          ";
		  /* if($_SESSION['orgname1']<>'')
		  $data.="<option value='".$_SESSION['orgname1']."'>".$_SESSION['orgname1']."</option>";
		 else */
		  $data.="<option value=''>-All-</option>";
		 $querysubcomponent=mysql_query("select * from tbl_subcomponent where subcomponent <> '' group by subcomponent_code order by subcomponent_code asc")or die(mysql_error());
		...
		$selectedsubcomponent=$_SESSION['subcomponentorg']==$rowsubcomponent['subcomponent']?"SELECTED":"";
		 ...
		 $data.="</select></td><td width='' class='evenrow'><strong>Sub-Sector</strong></td> <td class='evenrow' colspan=''><b>Organization Type:</b><td class='evenrow' colspan=2><strong>District:</strong></td>

    </tr>
		
		<tr class='evenrow'>
        <td width='' colspan='3' class=''><strong>Organisation:</strong></td> <td width='' class='evenrow' colspan='3' ><select name='orgname' size='1' class='' id='orgname'>
          <option value=''>-All-</option>
          ";
		  /* if($_SESSION['orgname1']<>'')
		  $data.="<option value='".$_SESSION['orgname1']."'>".$_SESSION['orgname1']."</option>";
		...
		<td width='' class='evenrow'><select name='subsector' size='1' class='' id='subsector'>";
		 
		  $data.="<option value=''>-All-</option>";
		 $querysubsector=mysql_query("select * from tbl_subsector where subsector <> '' group by subsector_id order by subsector_id asc")or die(mysql_error());
		...
		$selectedsubsector=$_SESSION['subsectororg']==$rowsubsector['subsector']?"SELECTED":"";
		 ...
		 $data.="</select></td>
	<td class='evenrow'><select name='orgtype' size='1' class='' id='orgtype'>
           <option value=''>-All-</option>
		   ";
		 /*  if($_SESSION['orgtype1']<>'')
		  $data.="<option value='".$_SESSION['orgtype1']."'>".$_SESSION['orgtype1']."</option>";
		 else */
		  $data.="<option value=''>-All-</option>";
		 ...
		 $data.="
	     </select></td><td><select name='district' size='1' class='' id='district'>
           <option value=''>-All-</option>
		   ";
		 
		  $data.="<option value=''>-All-</option>";
		  $query=mysql_query("select distinct(district) from tbl_organization where district <> '' group by district order by district asc")or die(mysql_error());
		 ...
		 $data.="
		   ...
		   <td class='evenrow'><input name='search' type='button' value='Go' 
		 onclick=\"xajax_view_organization(getElementById('subcomponent').value,getElementById('subsector').value,getElementById('orgname').value,getElementById('orgtype').value,getElementById('district').value);\" /></td></tr>
...
$data="
  ...
  <tr CLASS='evenrow2'>
	...
	//$data.="<option value='".$_SESSION['programme']."' 'selelcted'>".$_SESSION['programme']."</option>";
	 $query1=mysql_query("select * from tbl_programme where lower(program_name) like '%".strtolower($_SESSION['programme'])."%' order by program_name asc")or die(mysql_error());
	  while($row1=mysql_fetch_array($query1)){
	...
	$data.="<option value='%' >-All-</option>";
     ...
     $data.="</select></td>
    <td><select name='funder' id='funder'>";
	if($_SESSION['funder']!=''){
	//$data."<option value='".$_SESSION['funder']."' 'selected'>".$_SESSION['funder']."</option>";
	 $query2=mysql_query("select * from tbl_programme where lower(Funder) like '%".strtolower($_SESSION['funder'])."%' order by Funder")or die(mysql_error());
	  while($row2=mysql_fetch_array($query2)){
	...
	$data.="<option value='%' >-All-</option>"; 
	  $query2=mysql_query("select * from tbl_programme where Funder <> '' order by Funder")or die(mysql_error());
	  while($row2=mysql_fetch_array($query2)){
	   //$select=($_SESSION['funder']==$row1['Funder'])?"SELECTED":"";
	  $data.="<option value='".$row2['Funder']."%' '".$select."'>".substr($row2['Funder'],0,50)."</option>";
...
$data="<tr CLASS='evenrow2'>
  ...
  <tr CLASS='evenrow2'>
	...
	<td><label>
	  ...
	  $query2=mysql_query("select * from tbl_component where lower(component) like '%".strtolower($_SESSION['component'])."%' order by component asc")or die(mysql_error());
	...
	<td>
	 ...
	 $query1=mysql_query("select * from tbl_programme where lower(program_name) like '%".strtolower($_SESSION['program_name'])."%' order by program_name asc")or die(mysql_error());
	  while($row1=mysql_fetch_array($query1)){
	 
	  $data.="<option value='".$row1['program_name']."%' >".$row1['program_name']."</option>";
 ...
 <input type='button' name='new_programme' value='Add Sub-Component' onclick=\"xajax_add_subcomponent('');return false;\" />
  ...
  <tr CLASS='evenrow2'>
    <td><label>
	  ...
	  $query=mysql_query("select * from tbl_subcomponent where lower(subcomponent_code) like '%".strtolower($_SESSION['ssubcomponent_code'])."%'  order by subcomponent_code")or die(mysql_error());
	  while($row=mysql_fetch_array($query)){
	  ...
	  $data.="<option value='%".$row['subcomponent_code']."%' >".$row['subcomponent_code']."</option>";
	   ...
	   $data.="<option value='' >-All-</option>";
	  $query1=mysql_query("select * from tbl_subcomponent where subcomponent_code <> '' order by subcomponent_code")or die(mysql_error());
	...
	<td><label>
      <select name='subcomponent' id='subcomponent'>";
	  if($_SESSION['ssubcomponent']<>''){
	  $query2=mysql_query("select * from tbl_subcomponent where lower(subcomponent) like '".strtolower($_SESSION['ssubcomponent'])."%' and subcomponent <> '' order by subcomponent")or die("aBi error-code 1789 because, ".mysql_error());
	  while($row2=mysql_fetch_array($query2)){
	  ...
	  $data.="<option value='%' >-All-</option>";
	 $query2=mysql_query("select * from tbl_subcomponent where subcomponent <> '' order by subcomponent")or die("aBi error-code 1796 because, ".mysql_error());
	  while($row2=mysql_fetch_array($query2)){
	  $data.="<option value='".$row2['subcomponent']."%'>".$row2['subcomponent_code']." ".$row2['subcomponent']."</option>";
	  } 
  ...
  <tr CLASS='evenrow2'><td>COMPONENT:</td><td><label>
      <select name='component' id='component'>";
	  if($_SESSION['scomponent']<>''){
	  $query22=mysql_query("select * from tbl_component where lower(component) like '".strtolower($_SESSION['scomponent'])."' order by component asc")or die("aBi error-code 1812 because, ".mysql_error());
	  ...
	  $query23=mysql_query("select * from tbl_component  order by component asc")or die("aBi error-code 1821 because, ".mysql_error());
	  while($row23=mysql_fetch_array($query23)){
	  $data.="<option value='".$row23['component']."%' >".$row23['component']."</option>";
	  }
     $data.="</select>
    </label></td><td align=left><SELECT name='programme' id='programme'>";
	/* if($_SESSION['sprogramme']!=''){
	 ...
	 $query13=mysql_query("select * from tbl_programme where lower(program_name) like '%".strtolower($_SESSION['sprogramme'])."%' order by program_name asc")or die(mysql_error());
	  ...
	  $data.="<option value='".$row13['program_name']."%' >".$row13['program_name']."</option>";
	 ...
	 */
	$data.="<option value='%' >-All-</option>";
	  $query13=mysql_query("select * from tbl_programme where program_name <> '' order by program_name asc")or die("aBi error-code 1839 because, ".mysql_error());
	  while($row13=mysql_fetch_array($query13)){
...
$data="<tr CLASS='evenrow2'>
  ...
  <tr CLASS='evenrow2'>
    <td><label>
	  ...
	  #$query=mysql_query("select output_code from tbl_output where lower(output_code) like '".strtolower($_SESSION['ooutput_code'])."%' order by output_code")or die(mysql_error());
	  #while($row=mysql_fetch_array($query)){
	  ...
	  $data.="<option value='%' >-All-</option>";
	   $query=mysql_query("select output_code from tbl_output where output_code <> '' order by output_code")or die(mysql_error());
	  while($row=mysql_fetch_array($query)){
	   $selected=($_SESSION['ooutput_code']==$row['output_code'])?"SELECTED":"";
	...
	<td><label>
      <select name='outputName' id='outputName'>";
	  if($_SESSION['ooutput_name']<>'')
	   //$query=mysql_query("select * from tbl_output where lower(output_name) like '".strtolower($_SESSION['ooutput_name'])."%' order by output_code")or die(mysql_error());
	 // while($row=mysql_fetch_array($query)){
	 // $selected=($_SESSION['ooutput_name']==$row['output_name'])?"SELECTED":"";
	  ...
	  $data.="<option value='%' >-All-</option>";
	  $query=mysql_query("select * from tbl_output where output_name <> '' order by output_code")or die(mysql_error());
	  while($row=mysql_fetch_array($query)){
	   $selected=($_SESSION['ooutput_name']==$row['output_name'])?"SELECTED":"";
  ...
  <tr CLASS='evenrow2'><td>SUB-COMPONENT:</td><td><label>
      <select name='subcomponent' id='subcomponent'>";
	...
	##$query=mysql_query("select * from tbl_component where lower(component) like  '".strtolower($_SESSION['component'])."%' order by component  asc")or die(mysql_error());
	#while($row=mysql_fetch_array($query)){
...
<tr CLASS='evenrow2'>
	...
	<td colspan='2'><div align='left' style='float:left;'>
	  ...
	  $data.="<option value='".$_SESSION['activity_code']."%' >".$_SESSION['activity_code']."</option><option value='%' >-All-</option>";
        ...
        $data.="<option value='%' >-All-</option>";
	  $query=mysql_query("select activity_code from tbl_activity where activity_code <> '' order by activity_code")or die(mysql_error());
	  while($row=mysql_fetch_array($query)){
	  $data.="
...
<tr CLASS='evenrow2'>
    ...
    <td>
      ACTIVITY:    </td>
    <td colspan='2'><select name='activity_name' id='activity_name'>";
	if($_SESSION['activity_name']<>'')
	  ...
	  $data.="<option value='".$_SESSION['activity_name']."%' >".$_SESSION['activity_code']." ".$_SESSION['activity_name']."</option><option value='%' >-All-</option>";
        ...
        $data.="<option value='%' >-All-</option>";
	  $query=mysql_query("select * from tbl_activity where activity_name <> '' order by activity_code asc")or die(mysql_error());
	  while($row=mysql_fetch_array($query)){
	  $data.="
  ...
  <tr CLASS='evenrow2'>
	...
	<td width='100'><select name='output' id='output'>";
	if($_SESSION['output']<>'')
	  $data.="<option value='".$_SESSION['output']."%' >".$_SESSION['output']."</option><option value='%' >-All-</option>";
	  else
        $data.="<option value='%' >-All-</option>";
	$query=mysql_query("select * from tbl_output where output_name <> '' order by output_code  asc")or die(mysql_error());
	while($row=mysql_fetch_array($query)){
	$data.="
...
$data="<tr CLASS='evenrow2'>
	...
	<td colspan='2'><div align='left' style='float:left;'>
	  ...
	  $query=mysql_query("select subactivity_code from tbl_subactivity where subactivity_code <> '' order by subactivity_code")or die(mysql_error());
	  while($row=mysql_fetch_array($query)){
...
<tr CLASS='evenrow2'>
	...
	<td colspan='2'><div align='left' style='float:left;'>
	  <select name='subactivity' id='subactivity'>
	  ...
	  $query=mysql_query("select * from tbl_subactivity where subactivity_name <> '' order by subactivity_code asc")or die(mysql_error());
	  while($row=mysql_fetch_array($query)){
...
<tr CLASS='evenrow2'>
    ...
    <td>
      ACTIVITY:    </td>
    <td colspan='2'><select name='activity' id='activity'>
	  ...
	  $query=mysql_query("select * from tbl_activity where activity_name <> '' order by activity_code")or die(mysql_error());
	  while($row=mysql_fetch_array($query)){
  ...
  <tr CLASS='evenrow2'>
    ...
    <td><select name='subcomponent' id='subcomponent'>
	  ...
	  $data.="<option value=''>-All-</option>";
	  $query=mysql_query("select * from tbl_subcomponent where subcomponent <> '' order by subcomponent_code")or die(mysql_error());
	  while($row=mysql_fetch_array($query)){
...
#*********************************
/*
function filter_indicator_backup2(){

 $data="

  <tr><th scope='col' colspan='10'>
    Type of Indicator:
   
    <div ><select name='type_ofindicator' id='type_ofindicator'  ><option value=''>-All-</option>";
	//onchange=\"xajax_check_viewIndicatorType(getElementById('type_ofindicator').value);return false;\"
					if($_SESSION['subcomponent']!=NULL)
	  $data.="<option value='".$_SESSION['subcomponent']."'>".$_SESSION['subcomponent']."</option><option value=''>-All-</option>";
	  else
	  $data.="<option value=''>-All-</option>"; 
					$q=mysql_query("select * from view_indicator group by indicator_type order by indicator_type  asc")or die(mysql_error());
					while($rowL=mysql_fetch_array($q)){
$selected=$_SESSION['indicatorType']==$rowL['indicator_type']?"SELECTED":"";
$data.="<option value='".$rowL['indicator_type']."' '".$selected."'>".$rowL['indicator_type']."</option>";					
					
					}

					  $data.="			  
                      </select></div><div style='float:right;'><a href='export_to_excel_word.php?linkvar=Export Indicator&&indicator_type=".$_SESSION['indicatorType']."&&subcomponent=".$_SESSION['subcomponent']."&&output=".$_SESSION['output']."&&activity=".$_SESSION['activity']."&&subactivity=".$_SESSION['subactivity']."&&target=".$_SESSION['target']."&&indicator=".$_SESSION['indicator']."&&format=excel'><input type='button' name='export' value='Export to Excel' />
    </a>
  ...
  <tr><th scope='col' colspan='10' scope='col' class=evenrow><div align='left' width=165 COLSPAN=2>SUB-COMPONENT: </div>
    <div align='left' class=evenrow>
      <select name='subcomponent' id='subcomponent'>";
	  if($_SESSION['subcomponent']!=NULL)
	  $data.="<option value='".$_SESSION['subcomponent']."'>".substr($_SESSION['subcomponent'],0,50)."</option><option value=''>-All-</option>";
	  else
	  $data.="<option value=''>-All-</option>";
	 $query=mysql_query("select * from tbl_subcomponent where subcomponent <> '' order by subcomponent_code asc") or die(mysql_error());
	  while($row=mysql_fetch_array($query)){
	  
	  $data.="<option value='".$row['subcomponent']."'>".$row['subcomponent_code']." ".substr($row['subcomponent'],0,50)."</option>";
	  } 
      $data.="</select>
    </div></th>
  ...
  <tr>
    <th width='165' scope='col' colspan=10><div align='left' width=165>OUTPUT: </div><div align='left'>
      <select name='output' id='output'>";
	   if($_SESSION['output']!=NULL)
	  $data.="<option value='".$_SESSION['output']."'>".$_SESSION['output']."</option><option value=''>-All-</option>";
	  else
	  $data.="<option value=''>-All-</option>";
	 $query=mysql_query("select * from tbl_output where output_name <> '' group  by output_code order by output_code asc") or die(mysql_error());
	  while($row=mysql_fetch_array($query)){
	  
	  $data.="<option value='".$row['output_name']."'>".$row['output_code']." ".substr($row['output_name'],0,50)."</option>";
	  } 
      $data.="</select>
    </div></th>
  ...
  <tr>
    <th width='165' scope='col' class=evenrow><div align='left' width=165>ACTIVITY: </div></th>
    <th scope='col' colspan=2><div align='left' class=evenrow>
      <select name='activity' id='activity'>";
	  if($_SESSION['activity']!=NULL)
	  $data.="<option value='".$_SESSION['activity']."'>".$_SESSION['activity']."</option><option value=''>-All-</option>";
	  else
	  $data.="<option value=''>-All-</option>";
	 $query=mysql_query("select * from tbl_activity where activity_name <> '' group by activity_code order by activity_code asc") or die(mysql_error());
	  while($row=mysql_fetch_array($query)){
	  
	  $data.="<option value='".$row['activity_name']."'>".$row['activity_code']." ".substr($row['activity_name'],0,50)."</option>";
	  } 
      $data.="</select>
    </div></th>
  ...
  <tr>
    <th width='165' scope='col'><div align='left' width=165>SUB-ACTIVITY: </div></th>
    <th scope='col' colspan=2><div align='left'>
      <select name='subactivity' id='subactivity'>";
	  if($_SESSION['subactivity']!=NULL)
	  $data.="<option value='".$_SESSION['subactivity']."'>".substr($_SESSION['subactivity'],0,50)."</option><option value=''>-All-</option>";
	  else
	  $data.="<option value=''>-All-</option>";
	 
	 $query=mysql_query("select * from tbl_subactivity where subactivity_name <> '' group by subactivity_code order by subactivity_code asc") or die(mysql_error());
	  while($row=mysql_fetch_array($query)){
	  
	  $data.="<option value='".$row['subactivity_name']."'>".substr($row['subactivity_code'],0,50)." ".$row['subactivity_name']."</option>";
	  } 
      $data.="
      </select>
    </div></th>
  ...
  <tr>
    ...
    <th scope='col' colspan=2 class=evenrow><div align='left'>
	  ...
	  $data.="<option value='".$_SESSION['target']."'>".substr($_SESSION['target'],0,50)."</option><option value=''>-All-</option>";
	  else
	  $data.="<option value=''>-All-</option>";
	  
	 $query=mysql_query("select * from tbl_indicator where physical_target <> ''  group by physical_target order by physical_target asc") or die(mysql_error());
	  while($row=mysql_fetch_array($query)){
	  
	  $data.="<option value='".$row['physical_target']."'>".substr($row['physical_target'],0,50)."</option>";
	  } 
      $data.="</select>
    </div></th>
 ...
 <select name='indicator_name' id='indicator_name'>";
  if($_SESSION['indicator11']!='')
	  $data.="<option value='".$_SESSION['indicator11']."'>".substr($_SESSION['indicator11'],0,50)."</option><option value=''>-All-</option>";

$query=mysql_query("select * from tbl_indicator where indicator_name like '".$_SESSION['indicator11']."%' group by indicator_name order by indicator_name asc")or die("aBi error -code 2402 because, ".mysql_error());
	  while($row=mysql_fetch_array($query)){
	  $data.=<option value='".substr($row['indicator_name'],0,50)."'>".$row['indicator_name']."";
	  } 
	  ...
	  $data.="</option><option value=''>-All-</option>";
	 $query=mysql_query("select * from tbl_indicator where indicator_name <> '' group by indicator_name order by indicator_name asc")or die(mysql_error());
	  while($row=mysql_fetch_array($query)){
	  
	  $data.="<option value='".substr($row['indicator_name'],0,50)."'>".$row['indicator_name']."</option>";
	  } 
      $data.="<option value=''>-All-</option></select>
    </div></th><th width='31'><input name='search' type='button' value='Go' onclick=\"xajax_view_indicator(getElementById('type_ofindicator').value,getElementById('subcomponent').value,getElementById('output').value,getElementById('activity').value,getElementById('subactivity').value,getElementById('physical_target').value,getElementById('indicator_name').value); return false;\" align=right /></th>
...
$data="<tr class=''>
    <td colspan='16' scope='cols' class='greenlinks'>Setup &raquo; View Indicator</td>
  </tr>
  <tr class=''>
    <td colspan='16' scope='cols' align='left' ><hr width='100%'/></td>
  </tr>
<tr class='evenrow'><td scope='col' colspan=3>
        <div align='left'>Type of Indicator:        </div>
        <div ></div>
        <div style='float:right;'></div></td>
    <td scope='col' colspan='6'> <select name='type_ofindicator' id='type_ofindicator'  >
        <option value=''>-All-</option>
        ";
...
$selected=$_SESSION['indicatorType']==$rowL['indicator_type']?"SELECTED":"";
$data.="
        <option value='".$rowL['indicator_type']."' '".$selected."'>".$rowL['indicator_type']."</option>
        ";					
    ...
    <td colspan='6' scope='col'><span style='float:right;'>
      ...
      <a href='export_to_excel_word.php?linkvar=Export Indicator&&indicator_type=".$_SESSION['indicatorType']."&&subcomponent=".$_SESSION['subcomponent']."&&output=".$_SESSION['output']."&&activity=".$_SESSION['activity']."&&subactivity=".$_SESSION['subactivity']."&&target=".$_SESSION['target']."&&indicator=".$_SESSION['indicator11']."&&format=excel'>
      <input type='button' name='export' value='Export to Excel' />
    </a>
    </span></td>
  </tr>
  <tr>
    <td scope='col' colspan='3' class='evenrow'><div align='left'>
     SUB-COMPONENT:
    </div></td>
    <td colspan='10' scope='col' class='evenrow'><div align='left'><span class='evenrow'> 
      <select name='subcomponent' id='subcomponent'>";
	  if($_SESSION['subcomponent']!=NULL)
	  $data.="<option value='".$_SESSION['subcomponent']."'>".$_SESSION['subcomponent']."</option>";
	  else
	  $data.="<option value=''>-All-</option>";
	 $query=mysql_query(" select * from tbl_subcomponent where subcomponent <>'' order by subcomponent_code asc") or die("aBi Error-code:2462 because, ".mysql_error());
	  while($row=mysql_fetch_array($query)){
	  $data.="<option value='".$row['subcomponent']."'>".$row['subcomponent_code']." ".substr($row['subcomponent'],0,30)."</option>";
	  } 
      $data.="</select>
    </span></div></td>
  </tr>
  ...
  <tr class='evenrow'>
    <td width='165' scope='col' colspan=3><div align='left' width=165>OUTPUT: </div><div align='left'></div></td>
    <td colspan='9' scope='col'><div align='left'> <select name='output' id='output'>
        ";
	   if($_SESSION['output']!=NULL)
  ...
  <tr class='evenrow'>
    <td class=evenrow scope='col' colspan=3><div align='left' width=165>
     ACTIVITY: 
      </div></td>
    <td colspan='9' scope='col'><div align='left' class=evenrow>
      <select name='activity' id='activity'>
        ";
  ...
  <tr class='evenrow'>
    <td width='165' scope='col' colspan='3'><div align='left' width=165><span class='evenrow'>SUB-ACTIVITY: </span></div></td>
    <td scope='col' colspan=9><div align='left'><select name='subactivity' id='subactivity'>
        ";
	  if($_SESSION['subactivity']!=NULL)
	  $data.="
  ...
  <tr>
    <td width='165' class=evenrow scope='col' colspan=3><div align='left' width=165>
     PHYSICAL TARGET:  
    </div></td>
    <td scope='col' colspan=9 class=evenrow><div align='left'>
      <select name='physical_target' id='physical_target'>";
	   if($_SESSION['target']!=NULL)
 ...
 <tr class='evenrow'>
    <td width='165' scope='col' colspan='3'>INDICATOR:</td><td colspan='8'>
...
function filter_indicator_BACKUP(){
...
<table width='660' border='0'>
 <tr>
  ...
  <tr>
    <th width='165' scope='col' class=evenrow><div align='left' width=165 >SUB-COMPONENT: </div></th>
    <th scope='col' colspan=2><div align='left' class=evenrow>
      <select name='subcomponent' id='subcomponent' onchange=\"xajax_reloadview_indicator(getElementById('subcomponent').value)\">";
	  if($_SESSION['rsvsubcomponent_code']!='')$data.="<option value='".$_SESSION['rsvsubcomponent_code']."'>".$_SESSION['rsvsubcomponent_code']." ".$_SESSION['rsvsubcomponent']."</option>";
	  else $data.="<option value=''>-All-</option>";
	 $query=mysql_query("select * from tbl_subcomponent where subcomponent <> '' order by subcomponent_code asc") or die(mysql_error());
	  while($row=mysql_fetch_array($query)){
  ...
  <tr>
    ...
    <th scope='col' colspan=2><div align='left'>
      <select name='output' id='output'>";
	 $query=mysql_query("select * from view_indicator where output_name <> '' && subcomponent_code like '".$_SESSION['rsvsubcomponent_code']."%' order by output_code asc") or die(mysql_error());
	  while($row=mysql_fetch_array($query)){
	  
	  $data.="<option value='".$row['output_code']."%'>".$row['output_code']." ".$row['output_name']."</option>";
	  } 
      $data.="</select>
    </div></th>
  ...
  <tr>
    ...
    <th scope='col' colspan=2 class=evenrow><div align='left' >
      <select name='activity' id='activity'>";
	 $query=mysql_query("select * from view_indicator where activity_name <> '' && subcomponent_code like '".$_SESSION['rsvsubcomponent_code']."%' order by activity_code asc") or die(mysql_error());
	  while($row=mysql_fetch_array($query)){
	  
	  $data.="<option value='".$row['activity_code']."%'>".$row['activity_code']." ".$row['activity_name']."</option>";
	  } 
      $data.="</select>
    </div></th>
  ...
  <tr>
    ...
    <th scope='col' colspan=2><div align='left'>
      <select name='subactivity' id='subactivity'>";
	 $query=mysql_query("select * from view_indicator where subactivity_name <> '' && subcomponent_code like '".$_SESSION['rsvsubcomponent_code']."%' order by subactivity_code asc") or die(mysql_error());
	  while($row=mysql_fetch_array($query)){
	  
	  $data.="<option value='".$row['subactivity_code']."%'>".$row['subactivity_code']." ".$row['subactivity_name']."</option>";
	  } 
      $data.="
      </select>
    </div></th>
  ...
  <tr>
    ...
    <th scope='col' colspan=2 class=evenrow><div align='left'>
      <select name='physical_target' id='physical_target'><option value=''>-All-</option>";
	 $query=mysql_query("select * from view_indicator where physical_target <> '' && subcomponent_code like '".$_SESSION['rsvsubcomponent_code']."%' order by physical_target asc") or die(mysql_error());
	  while($row=mysql_fetch_array($query)){
 ...
 <tr>
    ...
    <th width='306' scope='col'><div align='left'>
 <select name='indicator' id='indicator'><option value=''>-All-</option>";
	 $query=mysql_query("select * from view_indicator where indicator_name <> '' && subcomponent_code like '".$_SESSION['rsvsubcomponent_code']."%' order by indicator_name asc")or die(mysql_error());
	  while($row=mysql_fetch_array($query)){
	  
	  $data.="<option value='".$row['indicator_name']."'>".$row['indicator_name']."</option>";
	  } 
      $data.="</select>      </select>
    </div></th><th width='31'><input name='search' type='button' value='Go' onclick=\"xajax_search_indicator(getElementById('programme').value,getElementById('component').value,getElementById('subcomponent').value,getElementById('output').value,getElementById('activity').value,getElementById('subactivity').value,getElementById('physical_target').value,getElementById('indicator').value)\" align=right /></th>
...
<table width='660' border='0'>
 <tr>
  ...
  <tr>
    ...
    <th scope='col' colspan=2><div align='left'>
      <select name='physical_target' id='physical_target'><option value=''>-All-</option>";
	 $query=mysql_query("select * from view_indicator where physical_target <> '' order by physical_target asc") or die(mysql_error());
	  while($row=mysql_fetch_array($query)){
  ...
  <tr>
    ...
    <th scope='col' colspan=2><div align='left'>
      <select name='physical_target' id='physical_target'><option value=''>-All-</option>";
	 $query=mysql_query("select * from view_indicator where activity_name <> '' order by activity_name asc") or die(mysql_error());
	  while($row=mysql_fetch_array($query)){
  ...
  <tr>
    ...
    <th scope='col' colspan=2><div align='left'>
      <select name='physical_target' id='physical_target'>
	  <option value=''>-All-</option>";
	 $query=mysql_query("select * from view_indicator where physical_target <> '' group by physical_target order by physical_target asc") or die(mysql_error());
	  while($row=mysql_fetch_array($query)){
 ...
 <tr>
    ...
    <th width='306' scope='col'><div align='left'>
 <select name='indicator' id='indicator'><option value=''>-All-</option>";
	 $query=mysql_query("select * from view_indicator where indicator_name <> '' group by indicator_name order by indicator_name asc")or die(mysql_error());
	  while($row=mysql_fetch_array($query)){
        ...
        <a href='export_to_excel_word.php?linkvar=Export_Annual_Budget&&subcomponent=".$_SESSION['subcomponentpr']."&&activity=".$_SESSION['activitypr']."&&subactivity=".$_SESSION['subactivitypr']."&&year=".$_SESSION['yearpr']."&&format=excel'><input type='button' name='export' value='Export to Excel' />
            ...
            $data.="<tr class=evenrow >
              ...
              <td colspan='6'><select name='activity' id='activity' ><option value=''>-ALL-</option>";
					 ...
					 $query=mysql_query("select * from tbl_activity  order by activity_code asc")or die("Http error-code 3802 because,".mysql_error());
					  while($row=mysql_fetch_array($query)){
...
$data.="
<tr>
    <td scope='col' class=green_field colspan=4><div style='float:left;' > </div></td>
...
<tr class=evenrow>
              ...
              <td colspan='9'><select name='output' id='output' ><option value=''>-All-</option>";
			   /*  if($_SESSION['wpsubcomponent']!=''){
					  $query=mysql_query("select * from view_output where subcomponent_id like '".$_SESSION['usersubcomponent']."%' order by output_code asc")or die(mysql_error());
					  while($row=mysql_fetch_array($query)){
					  //$selected=($_SESSION['ou'])
					  $data.="<option value=\"".$row['output_name']."\" >".$row['output_code']." ".$row['output_name']."</option>";
					  }
...
<tr class='evenrow'>
  ...
  $selsubcomponent=($_SESSION['Resultsubcomponent']==$rowq['subcomponent'])?"SELECTED":"";
   ...
   $data.="<option value='".$_SESSION['Resultactivity112']."'>".$_SESSION['Resultactivity112']."</option>";
      ...
      $data.="<option value=''>-ALL-</option>";
   $query1=mysql_query("select * from tbl_activity order by activity_id asc")or die(mysql_error());
...
$data=" <tr class='evenrow'><td colspan='4'></td>
  ...
  <td scope='col' colspan='3'><div align='left'  >Subcomponent </div></td>  <td class=evenrow colspan='2'><select name='subcomponent' id='subcomponent'>
      <option value=''>-ALL-</option>";
      $query1=mysql_query("select * from tbl_subcomponent  order by id asc")or die("aBi Error-code 934 because, ".mysql_error());
      while($row1=mysql_fetch_array($query1)){
...
$end--;} while ($end>= 2010);
  ...
  <tr class='evenrow'><td width='=' scope='col' colspan='3' ><div align='left'>Indicator</div></td><td CLASS='evenrow' colspan='3'><select name='indicator' id='indicator'><option value=''>-ALL-</option>";
	...
	$query=mysql_query("select * from view_organizationreporting where indicator_type like 'Results Based%' group by indicator_name order by indicator_id asc ")or die(mysql_error());
      while($row=mysql_fetch_array($query)){
...
$data="<tr class='evenrow'>
  ...
  <tr class='evenrow'>
    <td scope='col' colspan=2>Subcomponent:</td>
    <td scope='col' colspan=5><select name='subcomponent' id='subcomponent'>";
...
$data.="<option value='".$row['subcomponent']."' >".$row['subcomponent_code']." ".$row['subcomponent']."</option>";
					  ...
					  $data.="<option value=''>-All-</option>";
	$sel2=mysql_query("select * from tbl_subcomponent order by id asc ")or die("aBi Error-code 4145 because ".mysql_error());
    ...
    <td scope='col' colspan=5><select name='output' id='outputw'><option value=''>-ALL-</option>";
	$sew=mysql_query("select * from tbl_output where subcomp_id like '".$_SESSION['usersubcomponent']."%'  order by output_id asc ")or die("aBi Error-code 1183 because ".mysql_error());
	...
	$sel3=mysql_query("select * from tbl_activity where subcomp_id like '".$_SESSION['usersubcomponent']."%' order by activity_id asc ")or die("aBi Error-code 1183 because ".mysql_error());
	...
	$sel=mysql_query("select i.indicator_id,i.indicator_name,i.subcomponent_id,s.subact_id,s.subactivity_code,s.subactivity_name from tbl_indicator i  inner join tbl_organizationreporting r on(i.indicator_id=r.indicator_id) inner join tbl_subactivity s on(i.subactivity_id=s.subact_id) where subactivity_name <> '' and i.subcomponent_id like '".$_SESSION['usersubcomponent']."%' group by s.subact_id order by subactivity_code")or die("aBi Error-code 1183 because ".mysql_error());
	while($row1=mysql_fetch_array($sel)){
...
$data="<tr class='evenrow'>
  ...
  <tr class='evenrow'>
	...
	$sel3=mysql_query("select * from tbl_subsector order by subsector asc ")or die("aBi Error-code 1183 because ".mysql_error());
	while($row13=mysql_fetch_array($sel3)){
  ...
  <tr class='evenrow'>
	...
	$sew=mysql_query("select * from tbl_intervention  order by intervention asc ")or die("aBi Error-code 1183 because ".mysql_error());
	while($row14=mysql_fetch_array($sew)){
   ...
   <td scope='col' colspan=2>Result Chain:</td>
	...
	$sel3=mysql_query("select * from tbl_resultschain order by name asc ")or die("aBi Error-code 1183 because ".mysql_error());
	while($row13=mysql_fetch_array($sel3)){
	$s3=($_SESSION['resultschain']==$row13['name'])?"SELECTED":"";
	$data.="<option value='".$row13['name']."' '".$s3."'>".substr($row13['name'],0,50)."</option>";
