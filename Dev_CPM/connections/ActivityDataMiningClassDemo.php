 ...
 var $Query;
							...
							$x="SELECT 18 as indicator_id,
								...
								and `f`.`groupName` <>'No Group'";
							 	...
							 	$query=@Execute($x) or die(http("DM-004500"));
								...
								$x="SELECT 21 as indicator_id,
									...
									group by laboursavingtech";
							
							 	$query=@Execute($x) or die(http("DM-067"));
								$result=FetchRecords($query);
								return $result[$resultValue];
								break;
								...
								sum( if( `year` = '".TheFinancialYear($opening_year,$closure_year,0)."' and typeOfMedia<>'', 1, 0 ) ) AS notrainedYr1,
								sum( if( `year` = '".TheFinancialYear($opening_year,$closure_year,1)."' and typeOfMedia<>'', 1, 0 ) ) AS notrainedYr2,
								sum( if( `year` = '".TheFinancialYear($opening_year,$closure_year,2)."' and typeOfMedia<>'', 1, 0 ) ) AS notrainedYr3,
								sum( if( `year` = '".TheFinancialYear($opening_year,$closure_year,3)."' and typeOfMedia<>'', 1, 0 ) ) AS notrainedYr4,
								sum( if( `year` = '".TheFinancialYear($opening_year,$closure_year,4)."' and typeOfMedia<>'', 1, 0 ) ) AS notrainedYr5,
								sum( if( `year` = '".TheFinancialYear($opening_year,$closure_year,5)."' and typeOfMedia<>'', 1, 0 ) ) AS notrainedYr6
								FROM `tbl_mediaprograms` where 25=25
								group by typeOfMedia";
							
							 	$query=@Execute($x) or die(http("DM-075"));
								$result=FetchRecords($query);
								return $result[$resultValue];
								break;
								case 26:
								...
								FROM `tbl_youthapprentice` where 26=26";
							 	...
							 	$query=@Execute($x) or die(http("DM-089"));
								$result=FetchRecords($query);
								return $result[$resultValue];
								break;
								//--------------------------Rural Households---------------------------------
								...
								sum( if( `year` = '".TheFinancialYear($opening_year,$closure_year,0)."' and valueChain <>'', 1, 0 ) ) AS notrainedYr1,
								sum( if( `year` = '".TheFinancialYear($opening_year,$closure_year,1)."' and valueChain <>'', 1, 0 ) ) AS notrainedYr2,
								sum( if( `year` = '".TheFinancialYear($opening_year,$closure_year,2)."' and valueChain <>'', 1, 0 ) ) AS notrainedYr3,
								sum( if( `year` = '".TheFinancialYear($opening_year,$closure_year,3)."' and valueChain <>'', 1, 0 ) ) AS notrainedYr4,
								sum( if( `year` = '".TheFinancialYear($opening_year,$closure_year,4)."' and valueChain <>'', 1, 0 ) ) AS notrainedYr5,
								sum( if( `year` = '".TheFinancialYear($opening_year,$closure_year,5)."' and valueChain <>'', 1, 0 ) ) AS notrainedYr6
...
function grossMarginPerUnitOfLand($IndicatorID,$opening_year,$closure_year,$resultValue=""){
							...
							$x="SELECT 13 as indicator_id,
								...
								where 13=13";
								$query=@Execute($x) or die(http("iDissagDM-45"));
								$result=FetchRecords($query);
							...
							$x="SELECT 13 as indicator_id,
								...
								join `tbl_frm6production_maize` as `m` on (`m`.`fk_patid`=`c`.`fk_patid`)
								where 13=13";
								$query=@Execute($x) or die(http("iDissagDM-65"));
								$result=FetchRecords($query);
							...
							$x="SELECT 13 as indicator_id,
								...
								join `tbl_frm6production_maize` as `m` on (`m`.`fk_patid`=`c`.`fk_patid`)
								where 13=13";
								$query=@Execute($x) or die(http("iDissagDM-85"));
								$result=FetchRecords($query);
							...
							$x="SELECT 13 as indicator_id,
								...
								join `tbl_frm6production_maize` as `m` on (`m`.`fk_patid`=`c`.`fk_patid`)
								where 13=13";
								$query=@Execute($x) or die(http("iDissagDM-105"));
								$result=FetchRecords($query);
...
function valueOfIncrementalSales($IndicatorID,$opening_year,$closure_year,$resultValue=""){
							...
							$x="SELECT 14 as indicator_id,
								...
								where 14=14";
								$query=@Execute($x) or die(http("DM-325"));
								$result=FetchRecords($query);
							...
							$x2="SELECT 14 as indicator_id,
								...
								where 14=14";
								$query=@Execute($x2) or die(http("DM-345"));
								$result=FetchRecords($query);
							...
							$x3="SELECT 14 as indicator_id,
								...
								where 14=14";
								$query=@Execute($x3) or die(http("DM-365"));
								$result=FetchRecords($query);
								...
								$result['notrainedYr1']=convertShillingsToDollars($incrementalSalesMaizeYr1+$incrementalSalesBeansYr1+$incrementalSalesCoffeeYr1);
								$result['notrainedYr2']=convertShillingsToDollars($incrementalSalesMaizeYr2+$incrementalSalesBeansYr2+$incrementalSalesCoffeeYr2);
								$result['notrainedYr3']=convertShillingsToDollars($incrementalSalesMaizeYr3+$incrementalSalesBeansYr3+$incrementalSalesCoffeeYr3);
								$result['notrainedYr4']=convertShillingsToDollars($incrementalSalesMaizeYr4+$incrementalSalesBeansYr4+$incrementalSalesCoffeeYr4);
								$result['notrainedYr5']=convertShillingsToDollars($incrementalSalesMaizeYr5+$incrementalSalesBeansYr5+$incrementalSalesCoffeeYr5);
								$result['notrainedYr6']=convertShillingsToDollars($incrementalSalesMaizeYr6+$incrementalSalesBeansYr6+$incrementalSalesCoffeeYr6);
								return $result[$resultValue];
							}
...
function shortTermAgriculturalFoodsecurityTraining($IndicatorID,$opening_year,$closure_year,$resultValue=""){
							...
							$x="SELECT 15 as indicator_id,
								sum( if( substr( trainingDate, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,0)."', 1, 0 ) ) AS notrainedFrm1Yr1,
								sum( if( substr( trainingDate, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,1)."', 1, 0 ) ) AS notrainedFrm1Yr2,
								sum( if( substr( trainingDate, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,2)."', 1, 0 ) ) AS notrainedFrm1Yr3,
								sum( if( substr( trainingDate, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,3)."', 1, 0 ) ) AS notrainedFrm1Yr4,
								sum( if( substr( trainingDate, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,4)."', 1, 0 ) ) AS notrainedFrm1Yr5,
								sum( if( substr( trainingDate, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,5)."', 1, 0 ) ) AS notrainedFrm1Yr6
...
function appliedTechnologiesManagementPractice($IndicatorID,$opening_year,$closure_year,$resultValue=""){
							...
							$x="SELECT 16 as indicator_id,
								...
								join `tbl_frm6production_maize` as `m` on (`m`.`fk_patid`=`c`.`fk_patid`)
								where 16=16";
								$query=@Execute($x) or die(http("DM-587"));
								$result=FetchRecords($query);
								$numFarmersFrm6Yr1=$result['numFarmersFrm6Yr1'];
								$numFarmersFrm6Yr2=$result['numFarmersFrm6Yr2'];
								$numFarmersFrm6Yr3=$result['numFarmersFrm6Yr3'];
								$numFarmersFrm6Yr4=$result['numFarmersFrm6Yr4'];
								$numFarmersFrm6Yr5=$result['numFarmersFrm6Yr5'];
								$numFarmersFrm6Yr6=$result['numFarmersFrm6Yr6'];
								
								//=====================form2==============
								$x2="SELECT 16 as indicator_id,
								sum( if( `t`.`year` = '".TheFinancialYear($opening_year,$closure_year,0)."' and (nameOfImprovedTech <> '' or nameOfImprovedTech <> null or techAdoptedInReportingPeriod <> '' or techAdoptedInReportingPeriod <> null or techContinuedFromPast<>'' or techContinuedFromPast<>null), 1, 0 ) ) AS numFarmersFrm2Yr1,
								sum( if( `t`.`year` = '".TheFinancialYear($opening_year,$closure_year,1)."' and (nameOfImprovedTech <> '' or nameOfImprovedTech <> null or techAdoptedInReportingPeriod <> '' or techAdoptedInReportingPeriod <> null or techContinuedFromPast<>'' or techContinuedFromPast<>null), 1, 0 ) ) AS numFarmersFrm2Yr2,
								sum( if( `t`.`year` = '".TheFinancialYear($opening_year,$closure_year,2)."' and (nameOfImprovedTech <> '' or nameOfImprovedTech <> null or techAdoptedInReportingPeriod <> '' or techAdoptedInReportingPeriod <> null or techContinuedFromPast<>'' or techContinuedFromPast<>null), 1, 0 ) ) AS numFarmersFrm2Yr3,
								sum( if( `t`.`year` = '".TheFinancialYear($opening_year,$closure_year,3)."' and (nameOfImprovedTech <> '' or nameOfImprovedTech <> null or techAdoptedInReportingPeriod <> '' or techAdoptedInReportingPeriod <> null or techContinuedFromPast<>'' or techContinuedFromPast<>null), 1, 0 ) ) AS numFarmersFrm2Yr4,
								sum( if( `t`.`year` = '".TheFinancialYear($opening_year,$closure_year,4)."' and (nameOfImprovedTech <> '' or nameOfImprovedTech <> null or techAdoptedInReportingPeriod <> '' or techAdoptedInReportingPeriod <> null or techContinuedFromPast<>'' or techContinuedFromPast<>null), 1, 0 ) ) AS numFarmersFrm2Yr5,
								sum( if( `t`.`year` = '".TheFinancialYear($opening_year,$closure_year,5)."' and (nameOfImprovedTech <> '' or nameOfImprovedTech <> null or techAdoptedInReportingPeriod <> '' or techAdoptedInReportingPeriod <> null or techContinuedFromPast<>'' or techContinuedFromPast<>null), 1, 0 ) ) AS numFarmersFrm2Yr6
...
function numPrivateEnterprisesAppleiedTechnology($IndicatorID,$opening_year,$closure_year,$resultValue=""){
							...
							$x="SELECT 19 as indicator_id,
								...
								sum( if( `t`.`year` = '".TheFinancialYear($opening_year,$closure_year,0)."' && (nameOfImprovedTech <> '' || nameOfImprovedTech <> null || techAdoptedInReportingPeriod <> '' || techAdoptedInReportingPeriod <> null || techContinuedFromPast<>'' || techContinuedFromPast<>null), 1, 0 ) ) AS numEnterprisesFrm2Yr1,
								sum( if( `t`.`year` = '".TheFinancialYear($opening_year,$closure_year,1)."' && (nameOfImprovedTech <> '' || nameOfImprovedTech <> null || techAdoptedInReportingPeriod <> '' || techAdoptedInReportingPeriod <> null || techContinuedFromPast<>'' || techContinuedFromPast<>null), 1, 0 ) ) AS numEnterprisesFrm2Yr2,
								sum( if( `t`.`year` = '".TheFinancialYear($opening_year,$closure_year,2)."' && (nameOfImprovedTech <> '' || nameOfImprovedTech <> null || techAdoptedInReportingPeriod <> '' || techAdoptedInReportingPeriod <> null || techContinuedFromPast<>'' || techContinuedFromPast<>null), 1, 0 ) ) AS numEnterprisesFrm2Yr3,
								sum( if( `t`.`year` = '".TheFinancialYear($opening_year,$closure_year,3)."' && (nameOfImprovedTech <> '' || nameOfImprovedTech <> null || techAdoptedInReportingPeriod <> '' || techAdoptedInReportingPeriod <> null || techContinuedFromPast<>'' || techContinuedFromPast<>null), 1, 0 ) ) AS numEnterprisesFrm2Yr4,
								sum( if( `t`.`year` = '".TheFinancialYear($opening_year,$closure_year,4)."' && (nameOfImprovedTech <> '' || nameOfImprovedTech <> null || techAdoptedInReportingPeriod <> '' || techAdoptedInReportingPeriod <> null || techContinuedFromPast<>'' || techContinuedFromPast<>null), 1, 0 ) ) AS numEnterprisesFrm2Yr5,
								sum( if( `t`.`year` = '".TheFinancialYear($opening_year,$closure_year,5)."' && (nameOfImprovedTech <> '' || nameOfImprovedTech <> null || techAdoptedInReportingPeriod <> '' || techAdoptedInReportingPeriod <> null || techContinuedFromPast<>'' || techContinuedFromPast<>null), 1, 0 ) ) AS numEnterprisesFrm2Yr6
								FROM `tbl_techadoption` as `t`
								where 19=19";
								$query=@Execute($x2) or die(http("DM-596"));
								$result=FetchRecords($query);
...
function hectaresTechnologiesManagementPractice($IndicatorID,$opening_year,$closure_year,$resultValue=""){
							...
							$x="SELECT 20 as indicator_id,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,0)."', (`m`.`maize_improved_acreage` + `m`.`maize_chemical_acreage` + `m`.`maize_mgt_practices_acreage` + `m`.`maize_machinery_acreage` + `b`.`beans_improved_acreage` + `b`.`beans_chemical_acreage` + `b`.`beans_mgt_practices_acreage` + `b`.`beans_machinery_acreage` + `c`.`coffee_improved_acreage` + `c`.`coffee_chemical_acreage` + `c`.`coffee_mgt_practices_acreage` + `c`.`coffee_machinery_acreage`), 0 ) ) AS numAcresFrm6Yr1,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,1)."', (`m`.`maize_improved_acreage` + `m`.`maize_chemical_acreage` + `m`.`maize_mgt_practices_acreage` + `m`.`maize_machinery_acreage` + `b`.`beans_improved_acreage` + `b`.`beans_chemical_acreage` + `b`.`beans_mgt_practices_acreage` + `b`.`beans_machinery_acreage` + `c`.`coffee_improved_acreage` + `c`.`coffee_chemical_acreage` + `c`.`coffee_mgt_practices_acreage` + `c`.`coffee_machinery_acreage`), 0 ) ) AS numAcresFrm6Yr2,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,2)."', (`m`.`maize_improved_acreage` + `m`.`maize_chemical_acreage` + `m`.`maize_mgt_practices_acreage` + `m`.`maize_machinery_acreage` + `b`.`beans_improved_acreage` + `b`.`beans_chemical_acreage` + `b`.`beans_mgt_practices_acreage` + `b`.`beans_machinery_acreage` + `c`.`coffee_improved_acreage` + `c`.`coffee_chemical_acreage` + `c`.`coffee_mgt_practices_acreage` + `c`.`coffee_machinery_acreage`), 0 ) ) AS numAcresFrm6Yr3,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,3)."', (`m`.`maize_improved_acreage` + `m`.`maize_chemical_acreage` + `m`.`maize_mgt_practices_acreage` + `m`.`maize_machinery_acreage` + `b`.`beans_improved_acreage` + `b`.`beans_chemical_acreage` + `b`.`beans_mgt_practices_acreage` + `b`.`beans_machinery_acreage` + `c`.`coffee_improved_acreage` + `c`.`coffee_chemical_acreage` + `c`.`coffee_mgt_practices_acreage` + `c`.`coffee_machinery_acreage`), 0 ) ) AS numAcresFrm6Yr4,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,4)."', (`m`.`maize_improved_acreage` + `m`.`maize_chemical_acreage` + `m`.`maize_mgt_practices_acreage` + `m`.`maize_machinery_acreage` + `b`.`beans_improved_acreage` + `b`.`beans_chemical_acreage` + `b`.`beans_mgt_practices_acreage` + `b`.`beans_machinery_acreage` + `c`.`coffee_improved_acreage` + `c`.`coffee_chemical_acreage` + `c`.`coffee_mgt_practices_acreage` + `c`.`coffee_machinery_acreage`), 0 ) ) AS numAcresFrm6Yr5,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,5)."', (`m`.`maize_improved_acreage` + `m`.`maize_chemical_acreage` + `m`.`maize_mgt_practices_acreage` + `m`.`maize_machinery_acreage` + `b`.`beans_improved_acreage` + `b`.`beans_chemical_acreage` + `b`.`beans_mgt_practices_acreage` + `b`.`beans_machinery_acreage` + `c`.`coffee_improved_acreage` + `c`.`coffee_chemical_acreage` + `c`.`coffee_mgt_practices_acreage` + `c`.`coffee_machinery_acreage`), 0 ) ) AS numAcresFrm6Yr6
								from `tbl_frm6particulars` as `p`
								join `tbl_frm6production_beans` as `b` on (`b`.`fk_patid`=`p`.`pk_patid`)
								join `tbl_frm6production_coffee` as `c` on (`c`.`fk_patid`=`b`.`fk_patid`)
								join `tbl_frm6production_maize` as `m` on (`m`.`fk_patid`=`c`.`fk_patid`)
								...
								$query=@Execute($x) or die(http("DM-587"));
								$result=FetchRecords($query);
								$numAcresFrm6Yr1=$result['numAcresFrm6Yr1'];
								$numAcresFrm6Yr2=$result['numAcresFrm6Yr2'];
								$numAcresFrm6Yr3=$result['numAcresFrm6Yr3'];
								$numAcresFrm6Yr4=$result['numAcresFrm6Yr4'];
								$numAcresFrm6Yr5=$result['numAcresFrm6Yr5'];
								$numAcresFrm6Yr6=$result['numAcresFrm6Yr6'];
								
								//=====================form 8(demo book)==============
								$x2="SELECT 20 as indicator_id,
								sum( if( `d`.`year` = '".TheFinancialYear($opening_year,$closure_year,0)."', ((`d`.`sizePlotA`) + (`d`.`sizePlotB`) + (`d`.`sizePlotC`) + (`d`.`sizePlotD`)), 0 ) ) AS numAcresFrm8Yr1,
								sum( if( `d`.`year` = '".TheFinancialYear($opening_year,$closure_year,1)."', ((`d`.`sizePlotA`) + (`d`.`sizePlotB`) + (`d`.`sizePlotC`) + (`d`.`sizePlotD`)), 0 ) ) AS numAcresFrm8Yr2,
								sum( if( `d`.`year` = '".TheFinancialYear($opening_year,$closure_year,2)."', ((`d`.`sizePlotA`) + (`d`.`sizePlotB`) + (`d`.`sizePlotC`) + (`d`.`sizePlotD`)), 0 ) ) AS numAcresFrm8Yr3,
								sum( if( `d`.`year` = '".TheFinancialYear($opening_year,$closure_year,3)."', ((`d`.`sizePlotA`) + (`d`.`sizePlotB`) + (`d`.`sizePlotC`) + (`d`.`sizePlotD`)), 0 ) ) AS numAcresFrm8Yr4,
								sum( if( `d`.`year` = '".TheFinancialYear($opening_year,$closure_year,4)."', ((`d`.`sizePlotA`) + (`d`.`sizePlotB`) + (`d`.`sizePlotC`) + (`d`.`sizePlotD`)), 0 ) ) AS numAcresFrm8Yr5,
								sum( if( `d`.`year` = '".TheFinancialYear($opening_year,$closure_year,5)."', ((`d`.`sizePlotA`) + (`d`.`sizePlotB`) + (`d`.`sizePlotC`) + (`d`.`sizePlotD`)), 0 ) ) AS numAcresFrm8Yr6
								FROM `tbl_demo_book_details` as `d`
								JOIN `tbl_demo_records_book` as `dr` ON ( `dr`.`demoId` = `d`.`demoId` )
								where 20=20";
...
function jobsAttributedToFtFImplementation($IndicatorID,$opening_year,$closure_year,$resultValue){
			...
			$x1="SELECT 28 as indicator_id,
								sum( if( `t`.`year` = '".TheFinancialYear($opening_year,$closure_year,0)."' and `tj`.`nameOfJobHolder` <>'', 1, 0 ) ) AS noJobs1Yr1,
								sum( if( `t`.`year` = '".TheFinancialYear($opening_year,$closure_year,1)."' and `tj`.`nameOfJobHolder` <>'', 1, 0 ) ) AS noJobs1Yr2,
								sum( if( `t`.`year` = '".TheFinancialYear($opening_year,$closure_year,2)."' and `tj`.`nameOfJobHolder` <>'', 1, 0 ) ) AS noJobs1Yr3,
								sum( if( `t`.`year` = '".TheFinancialYear($opening_year,$closure_year,3)."' and `tj`.`nameOfJobHolder` <>'', 1, 0 ) ) AS noJobs1Yr4,
								sum( if( `t`.`year` = '".TheFinancialYear($opening_year,$closure_year,4)."' and `tj`.`nameOfJobHolder` <>'', 1, 0 ) ) AS noJobs1Yr5,
								sum( if( `t`.`year` = '".TheFinancialYear($opening_year,$closure_year,5)."' and `tj`.`nameOfJobHolder` <>'', 1, 0 ) ) AS noJobs1Yr6
								FROM `tbl_techadoption` as `t` 
								join `tbl_tech_adoption_jobholder` as `tj` 
								on `tj`.`techAdoption_id`=`t`.`tbl_techadoptionId`
								where 28=28";
							
							 	$query=@Execute($x1) or die(http("DM-771"));
			...
			$x2="SELECT 28 as indicator_id,
								sum( if( `s`.`year` = '".TheFinancialYear($opening_year,$closure_year,0)."' and `sj`.`nameOfJobHolder` <>'', 1, 0 ) ) AS noJobsYr1,
								sum( if( `s`.`year` = '".TheFinancialYear($opening_year,$closure_year,1)."' and `sj`.`nameOfJobHolder` <>'', 1, 0 ) ) AS noJobsYr2,
								sum( if( `s`.`year` = '".TheFinancialYear($opening_year,$closure_year,2)."' and `sj`.`nameOfJobHolder` <>'', 1, 0 ) ) AS noJobsYr3,
								sum( if( `s`.`year` = '".TheFinancialYear($opening_year,$closure_year,3)."' and `sj`.`nameOfJobHolder` <>'', 1, 0 ) ) AS noJobsYr4,
								sum( if( `s`.`year` = '".TheFinancialYear($opening_year,$closure_year,4)."' and `sj`.`nameOfJobHolder` <>'', 1, 0 ) ) AS noJobsYr5,
								sum( if( `s`.`year` = '".TheFinancialYear($opening_year,$closure_year,5)."' and `sj`.`nameOfJobHolder` <>'', 1, 0 ) ) AS noJobsYr6
								...
								where 28=28";
							 	...
							 	$query=@Execute($x2) or die(http("DM-793"));
			...
			$x3="SELECT 28 as indicator_id,
								sum( if( `m`.`year` = '".TheFinancialYear($opening_year,$closure_year,0)."' and `mj`.`nameOfJobHolder` <>'', 1, 0 ) ) AS noJobsYr1,
								sum( if( `m`.`year` = '".TheFinancialYear($opening_year,$closure_year,1)."' and `mj`.`nameOfJobHolder` <>'', 1, 0 ) ) AS noJobsYr2,
								sum( if( `m`.`year` = '".TheFinancialYear($opening_year,$closure_year,2)."' and `mj`.`nameOfJobHolder` <>'', 1, 0 ) ) AS noJobsYr3,
								sum( if( `m`.`year` = '".TheFinancialYear($opening_year,$closure_year,3)."' and `mj`.`nameOfJobHolder` <>'', 1, 0 ) ) AS noJobsYr4,
								sum( if( `m`.`year` = '".TheFinancialYear($opening_year,$closure_year,4)."' and `mj`.`nameOfJobHolder` <>'', 1, 0 ) ) AS noJobsYr5,
								sum( if( `m`.`year` = '".TheFinancialYear($opening_year,$closure_year,5)."' and `mj`.`nameOfJobHolder` <>'', 1, 0 ) ) AS noJobsYr6
								FROM `tbl_mediaprograms` as `m`
								join `tbl_mediaprogram_jobholder` as `mj` 
								on `mj`.`media_program_id`=`m`.`tbl_mediaprogramsId`
								where 28=28";
							
							 	$query=@Execute($x3) or die(http("DM-815"));
			...
			$x4="SELECT 28 as indicator_id,
								sum( if( `y`.`year` = '".TheFinancialYear($opening_year,$closure_year,0)."' and `yj`.`nameOfJobHolder` <>'', 1, 0 ) ) AS noJobsYr1,
								sum( if( `y`.`year` = '".TheFinancialYear($opening_year,$closure_year,1)."' and `yj`.`nameOfJobHolder` <>'', 1, 0 ) ) AS noJobsYr2,
								sum( if( `y`.`year` = '".TheFinancialYear($opening_year,$closure_year,2)."' and `yj`.`nameOfJobHolder` <>'', 1, 0 ) ) AS noJobsYr3,
								sum( if( `y`.`year` = '".TheFinancialYear($opening_year,$closure_year,3)."' and `yj`.`nameOfJobHolder` <>'', 1, 0 ) ) AS noJobsYr4,
								sum( if( `y`.`year` = '".TheFinancialYear($opening_year,$closure_year,4)."' and `yj`.`nameOfJobHolder` <>'', 1, 0 ) ) AS noJobsYr5,
								sum( if( `y`.`year` = '".TheFinancialYear($opening_year,$closure_year,5)."' and `yj`.`nameOfJobHolder` <>'', 1, 0 ) ) AS noJobsYr6
								FROM `tbl_youthapprentice` as `y`
								join `tbl_apprenticeship_jobholder` as `yj` 
								on `yj`.`apprenticeship_id`=`y`.`tbl_youthapprenticeId`
								where 28=28";
							
							 	$query=@Execute($x4) or die(http("DM-0104"));
			...
			$x5="SELECT 28 as indicator_id,
								sum( if( `p`.`year` = '".TheFinancialYear($opening_year,$closure_year,0)."' and `pj`.`nameOfJobHolder` <>'', 1, 0 ) ) AS noJobsYr1,
								sum( if( `p`.`year` = '".TheFinancialYear($opening_year,$closure_year,1)."' and `pj`.`nameOfJobHolder` <>'', 1, 0 ) ) AS noJobsYr2,
								sum( if( `p`.`year` = '".TheFinancialYear($opening_year,$closure_year,2)."' and `pj`.`nameOfJobHolder` <>'', 1, 0 ) ) AS noJobsYr3,
								sum( if( `p`.`year` = '".TheFinancialYear($opening_year,$closure_year,3)."' and `pj`.`nameOfJobHolder` <>'', 1, 0 ) ) AS noJobsYr4,
								sum( if( `p`.`year` = '".TheFinancialYear($opening_year,$closure_year,4)."' and `pj`.`nameOfJobHolder` <>'', 1, 0 ) ) AS noJobsYr5,
								sum( if( `p`.`year` = '".TheFinancialYear($opening_year,$closure_year,5)."' and `pj`.`nameOfJobHolder` <>'', 1, 0 ) ) AS noJobsYr6
								FROM `tbl_public_private_partnership` as `p` 
								join `tbl_partnership_jobholder` as `pj` 
								on `pj`.`partnership_id`=`p`.`tbl_partnershipId`
								where 28=28";
							
							 	$query=@Execute($x5) or die(http("DM-860"));
			...
			$x6="SELECT 28 as indicator_id,
								sum( if( `b`.`year` = '".TheFinancialYear($opening_year,$closure_year,0)."' and `bj`.`nameOfJobHolder` <>'', 1, 0 ) ) AS noJobsYr1,
								sum( if( `b`.`year` = '".TheFinancialYear($opening_year,$closure_year,1)."' and `bj`.`nameOfJobHolder` <>'', 1, 0 ) ) AS noJobsYr2,
								sum( if( `b`.`year` = '".TheFinancialYear($opening_year,$closure_year,2)."' and `bj`.`nameOfJobHolder` <>'', 1, 0 ) ) AS noJobsYr3,
								sum( if( `b`.`year` = '".TheFinancialYear($opening_year,$closure_year,3)."' and `bj`.`nameOfJobHolder` <>'', 1, 0 ) ) AS noJobsYr4,
								sum( if( `b`.`year` = '".TheFinancialYear($opening_year,$closure_year,4)."' and `bj`.`nameOfJobHolder` <>'', 1, 0 ) ) AS noJobsYr5,
								sum( if( `b`.`year` = '".TheFinancialYear($opening_year,$closure_year,5)."' and `bj`.`nameOfJobHolder` <>'', 1, 0 ) ) AS noJobsYr6
								FROM `tbl_bankloans` as `b`
								join `tbl_bank_loans_jobholder` as `bj` 
								on `bj`.`bankLoan_id`=`b`.`tbl_bankLoanId`
								where 28=28";
							
							 	$query=@Execute($x6) or die(http("DM-884"));
			...
			$x7="SELECT 28 as indicator_id,
								sum( if( `bds`.`year` = '".TheFinancialYear($opening_year,$closure_year,0)."' and `bdsj`.`nameOfJobHolder` <>'', 1, 0 ) ) AS noJobsYr1,
								sum( if( `bds`.`year` = '".TheFinancialYear($opening_year,$closure_year,1)."' and `bdsj`.`nameOfJobHolder` <>'', 1, 0 ) ) AS noJobsYr2,
								sum( if( `bds`.`year` = '".TheFinancialYear($opening_year,$closure_year,2)."' and `bdsj`.`nameOfJobHolder` <>'', 1, 0 ) ) AS noJobsYr3,
								sum( if( `bds`.`year` = '".TheFinancialYear($opening_year,$closure_year,3)."' and `bdsj`.`nameOfJobHolder` <>'', 1, 0 ) ) AS noJobsYr4,
								sum( if( `bds`.`year` = '".TheFinancialYear($opening_year,$closure_year,4)."' and `bdsj`.`nameOfJobHolder` <>'', 1, 0 ) ) AS noJobsYr5,
								sum( if( `bds`.`year` = '".TheFinancialYear($opening_year,$closure_year,5)."' and `bdsj`.`nameOfJobHolder` <>'', 1, 0 ) ) AS noJobsYr6
								FROM `tbl_businessdev` as `bds`
								join `tbl_bds_jobholder` as `bdsj` 
								on `bdsj`.`bds_id`=`bds`.`tbl_businessdevId`
								where 28=28";
							
							 	$query=@Execute($x7) or die(http("DM-906"));
			...
			$x8="SELECT 28 as indicator_id,
								sum( if( `ij`.`year` = '".TheFinancialYear($opening_year,$closure_year,0)."' and `ij`.`nameOfJobHolder` <>'', 1, 0 ) ) AS noJobsYr1,
								sum( if( `ij`.`year` = '".TheFinancialYear($opening_year,$closure_year,1)."' and `ij`.`nameOfJobHolder` <>'', 1, 0 ) ) AS noJobsYr2,
								sum( if( `ij`.`year` = '".TheFinancialYear($opening_year,$closure_year,2)."' and `ij`.`nameOfJobHolder` <>'', 1, 0 ) ) AS noJobsYr3,
								sum( if( `ij`.`year` = '".TheFinancialYear($opening_year,$closure_year,3)."' and `ij`.`nameOfJobHolder` <>'', 1, 0 ) ) AS noJobsYr4,
								sum( if( `ij`.`year` = '".TheFinancialYear($opening_year,$closure_year,4)."' and `ij`.`nameOfJobHolder` <>'', 1, 0 ) ) AS noJobsYr5,
								sum( if( `ij`.`year` = '".TheFinancialYear($opening_year,$closure_year,5)."' and `ij`.`nameOfJobHolder` <>'', 1, 0 ) ) AS noJobsYr6
								FROM `tbl_input_sales` as `i`
								join `tbl_input_sales_meta_data` as `ij` 
								on `ij`.`input_sales_id`=`i`.`id`
								where 28=28";
							
							 	$query=@Execute($x8) or die(http("DM-928"));
			...
			$x9="SELECT 28 as indicator_id,
								sum( if( `pj`.`year` = '".TheFinancialYear($opening_year,$closure_year,0)."' and `pj`.`nameOfJobHolder` <>'', 1, 0 ) ) AS noJobsYr1,
								sum( if( `pj`.`year` = '".TheFinancialYear($opening_year,$closure_year,1)."' and `pj`.`nameOfJobHolder` <>'', 1, 0 ) ) AS noJobsYr2,
								sum( if( `pj`.`year` = '".TheFinancialYear($opening_year,$closure_year,2)."' and `pj`.`nameOfJobHolder` <>'', 1, 0 ) ) AS noJobsYr3,
								sum( if( `pj`.`year` = '".TheFinancialYear($opening_year,$closure_year,3)."' and `pj`.`nameOfJobHolder` <>'', 1, 0 ) ) AS noJobsYr4,
								sum( if( `pj`.`year` = '".TheFinancialYear($opening_year,$closure_year,4)."' and `pj`.`nameOfJobHolder` <>'', 1, 0 ) ) AS noJobsYr5,
								sum( if( `pj`.`year` = '".TheFinancialYear($opening_year,$closure_year,5)."' and `pj`.`nameOfJobHolder` <>'', 1, 0 ) ) AS noJobsYr6
								FROM `tbl_phh` as `p`
								join `tbl_phh_meta_data` as `pj` 
								on `pj`.`phh_id`=`p`.`id`
								where 28=28";
							
							 	$query=@Execute($x9) or die(http("DM-950"));
...
function reductionInpostHarvestLosses ($IndicatorID,$opening_year,$closure_year,$resultValue=""){
							...
							$x="SELECT 36 as indicator_id,
								...
								where 36=36";
							 	...
							 	$query=@Execute($x2) or die(http("DM-1397"));
								$result=FetchRecords($query);
								...
								$result['notrainedYr1']=($lossForm6Yr1/$totProductionYr1);
								$result['notrainedYr2']=($lossForm6Yr2/$totProductionYr2);
								$result['notrainedYr3']=($lossForm6Yr3/$totProductionYr3);
								$result['notrainedYr4']=($lossForm6Yr4/$totProductionYr4);
								$result['notrainedYr5']=($lossForm6Yr5/$totProductionYr5);
								$result['notrainedYr6']=($lossForm6Yr6/$totProductionYr6);
								return $result[$resultValue];
							}
...
function RiskReducingPractices($IndicatorID,$opening_year,$closure_year,$resultValue=""){
								...
								$result['notrainedYr1']=$riskReducingPracticeYr1;
								$result['notrainedYr2']=$riskReducingPracticeYr2;
								$result['notrainedYr3']=$riskReducingPracticeYr3;
								$result['notrainedYr4']=$riskReducingPracticeYr4;
								$result['notrainedYr5']=$riskReducingPracticeYr5;
								$result['notrainedYr6']=$riskReducingPracticeYr6;
								return $result[$resultValue];
							}
//Value of Agricultural and Rural Loans							
function ValueofAgriculturalRuralLoans($IndicatorID,$opening_year,$closure_year,$resultValue=""){
							...
							$x="SELECT 29 as indicator_id,
								...
								$result['notrainedYr1']=convertShillingsToDollars($loanYr1+$loanForm6Yr1);
								$result['notrainedYr2']=convertShillingsToDollars($loanYr2+$loanForm6Yr2);
								$result['notrainedYr3']=convertShillingsToDollars($loanYr3+$loanForm6Yr3);
								$result['notrainedYr4']=convertShillingsToDollars($loanYr4+$loanForm6Yr4);
								$result['notrainedYr5']=convertShillingsToDollars($loanYr5+$loanForm6Yr5);
								$result['notrainedYr6']=convertShillingsToDollars($loanYr6+$loanForm6Yr6);
								return $result[$resultValue];
							}
...
function inputSales($IndicatorID,$opening_year,$closure_year,$resultValue=""){
								...
								$x="SELECT 22 as indicator_id,
									...
									where 22=22";
								$query=@Execute($x) or die(http("DM-1557"));
								$result=FetchRecords($query);
...
function PositiveBenefictsFromInputs($IndicatorID,$opening_year,$closure_year,$resultValue=""){
								...
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,0)."' and ((`m`.`maize_fertilizer_benefits`<>'' && `m`.`maize_fertilizer_benefits` not like '%4%' ) || (`m`.`maize_benefits` <>'' && `m`.`maize_benefits` not like '%4%' ) || (`m`.`maize_chemical_benefits` <>'' && `m`.`maize_chemical_benefits` not like '%4%' ) || (`m`.`maize_mgt_benefits` <>'' && `m`.`maize_mgt_benefits` not like '%4%' ) ), 1, 0 ) ) AS PositiveBenefitMaizeYr1,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,1)."' and ((`m`.`maize_fertilizer_benefits`<>'' && `m`.`maize_fertilizer_benefits` not like '%4%' ) || (`m`.`maize_benefits` <>'' && `m`.`maize_benefits` not like '%4%' ) || (`m`.`maize_chemical_benefits` <>'' && `m`.`maize_chemical_benefits` not like '%4%' ) || (`m`.`maize_mgt_benefits` <>'' && `m`.`maize_mgt_benefits` not like '%4%' ) ), 1, 0 ) ) AS PositiveBenefitMaizeYr2,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,2)."' and ((`m`.`maize_fertilizer_benefits`<>'' && `m`.`maize_fertilizer_benefits` not like '%4%' ) || (`m`.`maize_benefits` <>'' && `m`.`maize_benefits` not like '%4%' ) || (`m`.`maize_chemical_benefits` <>'' && `m`.`maize_chemical_benefits` not like '%4%' ) || (`m`.`maize_mgt_benefits` <>'' && `m`.`maize_mgt_benefits` not like '%4%' ) ), 1, 0 ) ) AS PositiveBenefitMaizeYr3,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,3)."' and ((`m`.`maize_fertilizer_benefits`<>'' && `m`.`maize_fertilizer_benefits` not like '%4%' ) || (`m`.`maize_benefits` <>'' && `m`.`maize_benefits` not like '%4%' ) || (`m`.`maize_chemical_benefits` <>'' && `m`.`maize_chemical_benefits` not like '%4%' ) || (`m`.`maize_mgt_benefits` <>'' && `m`.`maize_mgt_benefits` not like '%4%' ) ), 1, 0 ) ) AS PositiveBenefitMaizeYr4,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,4)."' and ((`m`.`maize_fertilizer_benefits`<>'' && `m`.`maize_fertilizer_benefits` not like '%4%' ) || (`m`.`maize_benefits` <>'' && `m`.`maize_benefits` not like '%4%' ) || (`m`.`maize_chemical_benefits` <>'' && `m`.`maize_chemical_benefits` not like '%4%' ) || (`m`.`maize_mgt_benefits` <>'' && `m`.`maize_mgt_benefits` not like '%4%' ) ), 1, 0 ) ) AS PositiveBenefitMaizeYr5,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,5)."' and ((`m`.`maize_fertilizer_benefits`<>'' && `m`.`maize_fertilizer_benefits` not like '%4%' ) || (`m`.`maize_benefits` <>'' && `m`.`maize_benefits` not like '%4%' ) || (`m`.`maize_chemical_benefits` <>'' && `m`.`maize_chemical_benefits` not like '%4%' ) || (`m`.`maize_mgt_benefits` <>'' && `m`.`maize_mgt_benefits` not like '%4%' ) ), 1, 0 ) ) AS PositiveBenefitMaizeYr6
								from `tbl_frm6particulars` as `p`
								join `tbl_frm6production_maize` as `m` on (`m`.`fk_patid`=`p`.`pk_patid`)
								where 23=23";
								$query=@Execute($x) or die(http("DM-1557"));
								$result=FetchRecords($query);
								$PositiveBenefitMaizeYr1=$result['PositiveBenefitMaizeYr1'];
								$PositiveBenefitMaizeYr2=$result['PositiveBenefitMaizeYr2'];
								$PositiveBenefitMaizeYr3=$result['PositiveBenefitMaizeYr3'];
								$PositiveBenefitMaizeYr4=$result['PositiveBenefitMaizeYr4'];
								$PositiveBenefitMaizeYr5=$result['PositiveBenefitMaizeYr5'];
								$PositiveBenefitMaizeYr6=$result['PositiveBenefitMaizeYr6'];
								//-----------------Beans--------------------------------
								$x2="SELECT 23 as indicator_id,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,0)."' and ((`b`.`beans_fertilizer_benefits`<>'' && `b`.`beans_fertilizer_benefits` not like '%4%' ) || (`b`.`beans_benefits` <>'' && `b`.`beans_benefits` not like '%4%' ) || (`b`.`beans_chemical_benefits` <>'' && `b`.`beans_chemical_benefits` not like '%4%' ) || (`b`.`beans_mgt_benefits` <>'' && `b`.`beans_mgt_benefits` not like '%4%' ) ), 1, 0 ) ) AS PositiveBenefitBeansYr1,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,1)."' and ((`b`.`beans_fertilizer_benefits`<>'' && `b`.`beans_fertilizer_benefits` not like '%4%' ) || (`b`.`beans_benefits` <>'' && `b`.`beans_benefits` not like '%4%' ) || (`b`.`beans_chemical_benefits` <>'' && `b`.`beans_chemical_benefits` not like '%4%' ) || (`b`.`beans_mgt_benefits` <>'' && `b`.`beans_mgt_benefits` not like '%4%' ) ), 1, 0 ) ) AS PositiveBenefitBeansYr2,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,2)."' and ((`b`.`beans_fertilizer_benefits`<>'' && `b`.`beans_fertilizer_benefits` not like '%4%' ) || (`b`.`beans_benefits` <>'' && `b`.`beans_benefits` not like '%4%' ) || (`b`.`beans_chemical_benefits` <>'' && `b`.`beans_chemical_benefits` not like '%4%' ) || (`b`.`beans_mgt_benefits` <>'' && `b`.`beans_mgt_benefits` not like '%4%' ) ), 1, 0 ) ) AS PositiveBenefitBeansYr3,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,3)."' and ((`b`.`beans_fertilizer_benefits`<>'' && `b`.`beans_fertilizer_benefits` not like '%4%' ) || (`b`.`beans_benefits` <>'' && `b`.`beans_benefits` not like '%4%' ) || (`b`.`beans_chemical_benefits` <>'' && `b`.`beans_chemical_benefits` not like '%4%' ) || (`b`.`beans_mgt_benefits` <>'' && `b`.`beans_mgt_benefits` not like '%4%' ) ), 1, 0 ) ) AS PositiveBenefitBeansYr4,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,4)."' and ((`b`.`beans_fertilizer_benefits`<>'' && `b`.`beans_fertilizer_benefits` not like '%4%' ) || (`b`.`beans_benefits` <>'' && `b`.`beans_benefits` not like '%4%' ) || (`b`.`beans_chemical_benefits` <>'' && `b`.`beans_chemical_benefits` not like '%4%' ) || (`b`.`beans_mgt_benefits` <>'' && `b`.`beans_mgt_benefits` not like '%4%' ) ), 1, 0 ) ) AS PositiveBenefitBeansYr5,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,5)."' and ((`b`.`beans_fertilizer_benefits`<>'' && `b`.`beans_fertilizer_benefits` not like '%4%' ) || (`b`.`beans_benefits` <>'' && `b`.`beans_benefits` not like '%4%' ) || (`b`.`beans_chemical_benefits` <>'' && `b`.`beans_chemical_benefits` not like '%4%' ) || (`b`.`beans_mgt_benefits` <>'' && `b`.`beans_mgt_benefits` not like '%4%' ) ), 1, 0 ) ) AS PositiveBenefitBeansYr6
								from `tbl_frm6particulars` as `p`
								join `tbl_frm6production_beans` as `b` on (`b`.`fk_patid`=`p`.`pk_patid`)
								where 23=23";
								$query=@Execute($x2) or die(http("DM-1576"));
								$result=FetchRecords($query);
								$PositiveBenefitBeansYr1=$result['PositiveBenefitBeansYr1'];
								$PositiveBenefitBeansYr2=$result['PositiveBenefitBeansYr2'];
								$PositiveBenefitBeansYr3=$result['PositiveBenefitBeansYr3'];
								$PositiveBenefitBeansYr4=$result['PositiveBenefitBeansYr4'];
								$PositiveBenefitBeansYr5=$result['PositiveBenefitBeansYr5'];
								$PositiveBenefitBeansYr6=$result['PositiveBenefitBeansYr6'];
								
								//-----------------Coffee--------------------------------
								$x2="SELECT 23 as indicator_id,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,0)."' and ((`c`.`coffee_fertilizer_benefits`<>'' && `c`.`coffee_fertilizer_benefits` not like '%4%' ) || (`c`.`coffee_benefits` <>'' && `c`.`coffee_benefits` not like '%4%' ) || (`c`.`coffee_chemical_benefits` <>'' && `c`.`coffee_chemical_benefits` not like '%4%' ) || (`c`.`coffee_mgt_benefits` <>'' && `c`.`coffee_mgt_benefits` not like '%4%' ) ), 1, 0 ) ) AS PositiveBenefitCoffeeYr1,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,1)."' and ((`c`.`coffee_fertilizer_benefits`<>'' && `c`.`coffee_fertilizer_benefits` not like '%4%' ) || (`c`.`coffee_benefits` <>'' && `c`.`coffee_benefits` not like '%4%' ) || (`c`.`coffee_chemical_benefits` <>'' && `c`.`coffee_chemical_benefits` not like '%4%' ) || (`c`.`coffee_mgt_benefits` <>'' && `c`.`coffee_mgt_benefits` not like '%4%' ) ), 1, 0 ) ) AS PositiveBenefitCoffeeYr2,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,2)."' and ((`c`.`coffee_fertilizer_benefits`<>'' && `c`.`coffee_fertilizer_benefits` not like '%4%' ) || (`c`.`coffee_benefits` <>'' && `c`.`coffee_benefits` not like '%4%' ) || (`c`.`coffee_chemical_benefits` <>'' && `c`.`coffee_chemical_benefits` not like '%4%' ) || (`c`.`coffee_mgt_benefits` <>'' && `c`.`coffee_mgt_benefits` not like '%4%' ) ), 1, 0 ) ) AS PositiveBenefitCoffeeYr3,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,3)."' and ((`c`.`coffee_fertilizer_benefits`<>'' && `c`.`coffee_fertilizer_benefits` not like '%4%' ) || (`c`.`coffee_benefits` <>'' && `c`.`coffee_benefits` not like '%4%' ) || (`c`.`coffee_chemical_benefits` <>'' && `c`.`coffee_chemical_benefits` not like '%4%' ) || (`c`.`coffee_mgt_benefits` <>'' && `c`.`coffee_mgt_benefits` not like '%4%' ) ), 1, 0 ) ) AS PositiveBenefitCoffeeYr4,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,4)."' and ((`c`.`coffee_fertilizer_benefits`<>'' && `c`.`coffee_fertilizer_benefits` not like '%4%' ) || (`c`.`coffee_benefits` <>'' && `c`.`coffee_benefits` not like '%4%' ) || (`c`.`coffee_chemical_benefits` <>'' && `c`.`coffee_chemical_benefits` not like '%4%' ) || (`c`.`coffee_mgt_benefits` <>'' && `c`.`coffee_mgt_benefits` not like '%4%' ) ), 1, 0 ) ) AS PositiveBenefitCoffeeYr5,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,5)."' and ((`c`.`coffee_fertilizer_benefits`<>'' && `c`.`coffee_fertilizer_benefits` not like '%4%' ) || (`c`.`coffee_benefits` <>'' && `c`.`coffee_benefits` not like '%4%' ) || (`c`.`coffee_chemical_benefits` <>'' && `c`.`coffee_chemical_benefits` not like '%4%' ) || (`c`.`coffee_mgt_benefits` <>'' && `c`.`coffee_mgt_benefits` not like '%4%' ) ), 1, 0 ) ) AS PositiveBenefitCoffeeYr6
								from `tbl_frm6particulars` as `p`
								join `tbl_frm6production_coffee` as `c` on (`c`.`fk_patid`=`p`.`pk_patid`)
								where 23=23";
								$query=@Execute($x2) or die(http("DM-1596"));
								$result=FetchRecords($query);
								$PositiveBenefitCoffeeYr1=$result['PositiveBenefitCoffeeYr1'];
								$PositiveBenefitCoffeeYr2=$result['PositiveBenefitCoffeeYr2'];
								$PositiveBenefitCoffeeYr3=$result['PositiveBenefitCoffeeYr3'];
								$PositiveBenefitCoffeeYr4=$result['PositiveBenefitCoffeeYr4'];
								$PositiveBenefitCoffeeYr5=$result['PositiveBenefitCoffeeYr5'];
								$PositiveBenefitCoffeeYr6=$result['PositiveBenefitCoffeeYr6'];
							...
							$x4="SELECT 23 as indicator_id,
								...
								join `tbl_frm6production_maize` as `m` on (`m`.`fk_patid`=`c`.`fk_patid`)
								where 23=23";
								$query=@Execute($x4) or die(http("DM-587"));
								$result=FetchRecords($query);
								...
								//SUMMING UP THE FARMERS WHO USE IMPROVED PRACTICES
								$totPositiveBenefitYr1= $PositiveBenefitMaizeYr1 + $PositiveBenefitBeansYr1 + $PositiveBenefitCoffeeYr1;
								$totPositiveBenefitYr2= $PositiveBenefitMaizeYr2 + $PositiveBenefitBeansYr2 + $PositiveBenefitCoffeeYr2;
								$totPositiveBenefitYr3= $PositiveBenefitMaizeYr3 + $PositiveBenefitBeansYr3 + $PositiveBenefitCoffeeYr3;
								$totPositiveBenefitYr4= $PositiveBenefitMaizeYr4 + $PositiveBenefitBeansYr4 + $PositiveBenefitCoffeeYr4;
								$totPositiveBenefitYr5= $PositiveBenefitMaizeYr5 + $PositiveBenefitBeansYr5 + $PositiveBenefitCoffeeYr5;
								$totPositiveBenefitYr6= $PositiveBenefitMaizeYr6 + $PositiveBenefitBeansYr6 + $PositiveBenefitCoffeeYr6;
								
								$result['notrainedYr1']=convertToPercentages($totPositiveBenefitYr1,$TotNumFarmersSurveyedYr1);
								$result['notrainedYr2']=convertToPercentages($totPositiveBenefitYr2,$TotNumFarmersSurveyedYr2);
								$result['notrainedYr3']=convertToPercentages($totPositiveBenefitYr3,$TotNumFarmersSurveyedYr3);
								$result['notrainedYr4']=convertToPercentages($totPositiveBenefitYr4,$TotNumFarmersSurveyedYr4);
								$result['notrainedYr5']=convertToPercentages($totPositiveBenefitYr5,$TotNumFarmersSurveyedYr5);
								$result['notrainedYr6']=convertToPercentages($totPositiveBenefitYr6,$TotNumFarmersSurveyedYr6);
								return $result[$resultValue];
							}
//---------------Percentage of farmers acknowledging positive benefits from the accessed inputs---------------		
function PurchasingInputFromVAs($IndicatorID,$opening_year,$closure_year,$resultValue=""){
								...
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,0)."' and ((`m`.`maize_seed_supplier`<>'' && `m`.`maize_seed_supplier` like '%1%' ) || (`m`.`maize_fertilizer_supplier` <>'' && `m`.`maize_fertilizer_supplier` like '%1%' ) || (`m`.`maize_chemical_supplier` <>'' && `m`.`maize_chemical_supplier` like '%1%' ) || (`m`.`maize_ict_supplier` <>'' && `m`.`maize_ict_supplier` like '%1%' ) || (`m`.`maize_machinery_supplier` <>'' && `m`.`maize_machinery_supplier` like '%1%' ) ), 1, 0 ) ) AS PurchaseMaizeVARMYr1,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,1)."' and ((`m`.`maize_seed_supplier`<>'' && `m`.`maize_seed_supplier` like '%1%' ) || (`m`.`maize_fertilizer_supplier` <>'' && `m`.`maize_fertilizer_supplier` like '%1%' ) || (`m`.`maize_chemical_supplier` <>'' && `m`.`maize_chemical_supplier` like '%1%' ) || (`m`.`maize_ict_supplier` <>'' && `m`.`maize_ict_supplier` like '%1%' ) || (`m`.`maize_machinery_supplier` <>'' && `m`.`maize_machinery_supplier` like '%1%' ) ), 1, 0 ) ) AS PurchaseMaizeVARMYr2,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,2)."' and ((`m`.`maize_seed_supplier`<>'' && `m`.`maize_seed_supplier` like '%1%' ) || (`m`.`maize_fertilizer_supplier` <>'' && `m`.`maize_fertilizer_supplier` like '%1%' ) || (`m`.`maize_chemical_supplier` <>'' && `m`.`maize_chemical_supplier` like '%1%' ) || (`m`.`maize_ict_supplier` <>'' && `m`.`maize_ict_supplier` like '%1%' ) || (`m`.`maize_machinery_supplier` <>'' && `m`.`maize_machinery_supplier` like '%1%' ) ), 1, 0 ) ) AS PurchaseMaizeVARMYr3,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,3)."' and ((`m`.`maize_seed_supplier`<>'' && `m`.`maize_seed_supplier` like '%1%' ) || (`m`.`maize_fertilizer_supplier` <>'' && `m`.`maize_fertilizer_supplier` like '%1%' ) || (`m`.`maize_chemical_supplier` <>'' && `m`.`maize_chemical_supplier` like '%1%' ) || (`m`.`maize_ict_supplier` <>'' && `m`.`maize_ict_supplier` like '%1%' ) || (`m`.`maize_machinery_supplier` <>'' && `m`.`maize_machinery_supplier` like '%1%' ) ), 1, 0 ) ) AS PurchaseMaizeVARMYr4,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,4)."' and ((`m`.`maize_seed_supplier`<>'' && `m`.`maize_seed_supplier` like '%1%' ) || (`m`.`maize_fertilizer_supplier` <>'' && `m`.`maize_fertilizer_supplier` like '%1%' ) || (`m`.`maize_chemical_supplier` <>'' && `m`.`maize_chemical_supplier` like '%1%' ) || (`m`.`maize_ict_supplier` <>'' && `m`.`maize_ict_supplier` like '%1%' ) || (`m`.`maize_machinery_supplier` <>'' && `m`.`maize_machinery_supplier` like '%1%' ) ), 1, 0 ) ) AS PurchaseMaizeVARMYr5,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,5)."' and ((`m`.`maize_seed_supplier`<>'' && `m`.`maize_seed_supplier` like '%1%' ) || (`m`.`maize_fertilizer_supplier` <>'' && `m`.`maize_fertilizer_supplier` like '%1%' ) || (`m`.`maize_chemical_supplier` <>'' && `m`.`maize_chemical_supplier` like '%1%' ) || (`m`.`maize_ict_supplier` <>'' && `m`.`maize_ict_supplier` like '%1%' ) || (`m`.`maize_machinery_supplier` <>'' && `m`.`maize_machinery_supplier` like '%1%' ) ), 1, 0 ) ) AS PurchaseMaizeVARMYr6
								from `tbl_frm6particulars` as `p`
								join `tbl_frm6production_maize` as `m` on (`m`.`fk_patid`=`p`.`pk_patid`)
								where 24=24";
								$query=@Execute($x) or die(http("DM-1557"));
								$result=FetchRecords($query);
								$PurchaseMaizeVARMYr1=$result['PurchaseMaizeVARMYr1'];
								$PurchaseMaizeVARMYr2=$result['PurchaseMaizeVARMYr2'];
								$PurchaseMaizeVARMYr3=$result['PurchaseMaizeVARMYr3'];
								$PurchaseMaizeVARMYr4=$result['PurchaseMaizeVARMYr4'];
								$PurchaseMaizeVARMYr5=$result['PurchaseMaizeVARMYr5'];
								$PurchaseMaizeVARMYr6=$result['PurchaseMaizeVARMYr6'];
								
								//-----------------Form6 Maize VA--------------------------------
								$x2="SELECT 24 as indicator_id,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,0)."' and ((`m`.`maize_seed_supplier`<>'' && `m`.`maize_seed_supplier` like '%2%' ) || (`m`.`maize_fertilizer_supplier` <>'' && `m`.`maize_fertilizer_supplier` like '%2%' ) || (`m`.`maize_chemical_supplier` <>'' && `m`.`maize_chemical_supplier` like '%2%' ) || (`m`.`maize_ict_supplier` <>'' && `m`.`maize_ict_supplier` like '%2%' ) || (`m`.`maize_machinery_supplier` <>'' && `m`.`maize_machinery_supplier` like '%2%' ) ), 1, 0 ) ) AS PurchaseMaizeVAYr1,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,1)."' and ((`m`.`maize_seed_supplier`<>'' && `m`.`maize_seed_supplier` like '%2%' ) || (`m`.`maize_fertilizer_supplier` <>'' && `m`.`maize_fertilizer_supplier` like '%2%' ) || (`m`.`maize_chemical_supplier` <>'' && `m`.`maize_chemical_supplier` like '%2%' ) || (`m`.`maize_ict_supplier` <>'' && `m`.`maize_ict_supplier` like '%2%' ) || (`m`.`maize_machinery_supplier` <>'' && `m`.`maize_machinery_supplier` like '%2%' ) ), 1, 0 ) ) AS PurchaseMaizeVAYr2,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,2)."' and ((`m`.`maize_seed_supplier`<>'' && `m`.`maize_seed_supplier` like '%2%' ) || (`m`.`maize_fertilizer_supplier` <>'' && `m`.`maize_fertilizer_supplier` like '%2%' ) || (`m`.`maize_chemical_supplier` <>'' && `m`.`maize_chemical_supplier` like '%2%' ) || (`m`.`maize_ict_supplier` <>'' && `m`.`maize_ict_supplier` like '%2%' ) || (`m`.`maize_machinery_supplier` <>'' && `m`.`maize_machinery_supplier` like '%2%' ) ), 1, 0 ) ) AS PurchaseMaizeVAYr3,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,3)."' and ((`m`.`maize_seed_supplier`<>'' && `m`.`maize_seed_supplier` like '%2%' ) || (`m`.`maize_fertilizer_supplier` <>'' && `m`.`maize_fertilizer_supplier` like '%2%' ) || (`m`.`maize_chemical_supplier` <>'' && `m`.`maize_chemical_supplier` like '%2%' ) || (`m`.`maize_ict_supplier` <>'' && `m`.`maize_ict_supplier` like '%2%' ) || (`m`.`maize_machinery_supplier` <>'' && `m`.`maize_machinery_supplier` like '%2%' ) ), 1, 0 ) ) AS PurchaseMaizeVAYr4,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,4)."' and ((`m`.`maize_seed_supplier`<>'' && `m`.`maize_seed_supplier` like '%2%' ) || (`m`.`maize_fertilizer_supplier` <>'' && `m`.`maize_fertilizer_supplier` like '%2%' ) || (`m`.`maize_chemical_supplier` <>'' && `m`.`maize_chemical_supplier` like '%2%' ) || (`m`.`maize_ict_supplier` <>'' && `m`.`maize_ict_supplier` like '%2%' ) || (`m`.`maize_machinery_supplier` <>'' && `m`.`maize_machinery_supplier` like '%2%' ) ), 1, 0 ) ) AS PurchaseMaizeVAYr5,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,5)."' and ((`m`.`maize_seed_supplier`<>'' && `m`.`maize_seed_supplier` like '%2%' ) || (`m`.`maize_fertilizer_supplier` <>'' && `m`.`maize_fertilizer_supplier` like '%2%' ) || (`m`.`maize_chemical_supplier` <>'' && `m`.`maize_chemical_supplier` like '%2%' ) || (`m`.`maize_ict_supplier` <>'' && `m`.`maize_ict_supplier` like '%2%' ) || (`m`.`maize_machinery_supplier` <>'' && `m`.`maize_machinery_supplier` like '%2%' ) ), 1, 0 ) ) AS PurchaseMaizeVAYr6
								from `tbl_frm6particulars` as `p`
								join `tbl_frm6production_maize` as `m` on (`m`.`fk_patid`=`p`.`pk_patid`)
								where 24=24";
								$query=@Execute($x2) or die(http("DM-1557"));
								$result=FetchRecords($query);
								$PurchaseMaizeVAYr1=$result['PurchaseMaizeVAYr1'];
								$PurchaseMaizeVAYr2=$result['PurchaseMaizeVAYr2'];
								$PurchaseMaizeVAYr3=$result['PurchaseMaizeVAYr3'];
								$PurchaseMaizeVAYr4=$result['PurchaseMaizeVAYr4'];
								$PurchaseMaizeVAYr5=$result['PurchaseMaizeVAYr5'];
								$PurchaseMaizeVAYr6=$result['PurchaseMaizeVAYr6'];
								
								//-----------------Form6 Maize Stockist--------------------------------
								$x3="SELECT 24 as indicator_id,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,0)."' and ((`m`.`maize_seed_supplier`<>'' && `m`.`maize_seed_supplier` like '%3%' ) || (`m`.`maize_fertilizer_supplier` <>'' && `m`.`maize_fertilizer_supplier` like '%3%' ) || (`m`.`maize_chemical_supplier` <>'' && `m`.`maize_chemical_supplier` like '%3%' ) || (`m`.`maize_ict_supplier` <>'' && `m`.`maize_ict_supplier` like '%3%' ) || (`m`.`maize_machinery_supplier` <>'' && `m`.`maize_machinery_supplier` like '%3%' ) ), 1, 0 ) ) AS PurchaseMaizeStockistYr1,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,1)."' and ((`m`.`maize_seed_supplier`<>'' && `m`.`maize_seed_supplier` like '%3%' ) || (`m`.`maize_fertilizer_supplier` <>'' && `m`.`maize_fertilizer_supplier` like '%3%' ) || (`m`.`maize_chemical_supplier` <>'' && `m`.`maize_chemical_supplier` like '%3%' ) || (`m`.`maize_ict_supplier` <>'' && `m`.`maize_ict_supplier` like '%3%' ) || (`m`.`maize_machinery_supplier` <>'' && `m`.`maize_machinery_supplier` like '%3%' ) ), 1, 0 ) ) AS PurchaseMaizeStockistYr2,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,2)."' and ((`m`.`maize_seed_supplier`<>'' && `m`.`maize_seed_supplier` like '%3%' ) || (`m`.`maize_fertilizer_supplier` <>'' && `m`.`maize_fertilizer_supplier` like '%3%' ) || (`m`.`maize_chemical_supplier` <>'' && `m`.`maize_chemical_supplier` like '%3%' ) || (`m`.`maize_ict_supplier` <>'' && `m`.`maize_ict_supplier` like '%3%' ) || (`m`.`maize_machinery_supplier` <>'' && `m`.`maize_machinery_supplier` like '%3%' ) ), 1, 0 ) ) AS PurchaseMaizeStockistYr3,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,3)."' and ((`m`.`maize_seed_supplier`<>'' && `m`.`maize_seed_supplier` like '%3%' ) || (`m`.`maize_fertilizer_supplier` <>'' && `m`.`maize_fertilizer_supplier` like '%3%' ) || (`m`.`maize_chemical_supplier` <>'' && `m`.`maize_chemical_supplier` like '%3%' ) || (`m`.`maize_ict_supplier` <>'' && `m`.`maize_ict_supplier` like '%3%' ) || (`m`.`maize_machinery_supplier` <>'' && `m`.`maize_machinery_supplier` like '%3%' ) ), 1, 0 ) ) AS PurchaseMaizeStockistYr4,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,4)."' and ((`m`.`maize_seed_supplier`<>'' && `m`.`maize_seed_supplier` like '%3%' ) || (`m`.`maize_fertilizer_supplier` <>'' && `m`.`maize_fertilizer_supplier` like '%3%' ) || (`m`.`maize_chemical_supplier` <>'' && `m`.`maize_chemical_supplier` like '%3%' ) || (`m`.`maize_ict_supplier` <>'' && `m`.`maize_ict_supplier` like '%3%' ) || (`m`.`maize_machinery_supplier` <>'' && `m`.`maize_machinery_supplier` like '%3%' ) ), 1, 0 ) ) AS PurchaseMaizeStockistYr5,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,5)."' and ((`m`.`maize_seed_supplier`<>'' && `m`.`maize_seed_supplier` like '%3%' ) || (`m`.`maize_fertilizer_supplier` <>'' && `m`.`maize_fertilizer_supplier` like '%3%' ) || (`m`.`maize_chemical_supplier` <>'' && `m`.`maize_chemical_supplier` like '%3%' ) || (`m`.`maize_ict_supplier` <>'' && `m`.`maize_ict_supplier` like '%3%' ) || (`m`.`maize_machinery_supplier` <>'' && `m`.`maize_machinery_supplier` like '%3%' ) ), 1, 0 ) ) AS PurchaseMaizeStockistYr6
								from `tbl_frm6particulars` as `p`
								join `tbl_frm6production_maize` as `m` on (`m`.`fk_patid`=`p`.`pk_patid`)
								where 24=24";
								$query=@Execute($x3) or die(http("DM-1557"));
								$result=FetchRecords($query);
								$PurchaseMaizeStockistYr1=$result['PurchaseMaizeStockistYr1'];
								$PurchaseMaizeStockistYr2=$result['PurchaseMaizeStockistYr2'];
								$PurchaseMaizeStockistYr3=$result['PurchaseMaizeStockistYr3'];
								$PurchaseMaizeStockistYr4=$result['PurchaseMaizeStockistYr4'];
								$PurchaseMaizeStockistYr5=$result['PurchaseMaizeStockistYr5'];
								$PurchaseMaizeStockistYr6=$result['PurchaseMaizeStockistYr6'];
								
								//-----------------Form6 Maize Others--------------------------------
								$x4="SELECT 24 as indicator_id,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,0)."' and ((`m`.`maize_seed_supplier`<>'' && `m`.`maize_seed_supplier` like '%4%' ) || (`m`.`maize_fertilizer_supplier` <>'' && `m`.`maize_fertilizer_supplier` like '%4%' ) || (`m`.`maize_chemical_supplier` <>'' && `m`.`maize_chemical_supplier` like '%4%' ) || (`m`.`maize_ict_supplier` <>'' && `m`.`maize_ict_supplier` like '%4%' ) || (`m`.`maize_machinery_supplier` <>'' && `m`.`maize_machinery_supplier` like '%4%' ) ), 1, 0 ) ) AS PurchaseMaizeOthersYr1,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,1)."' and ((`m`.`maize_seed_supplier`<>'' && `m`.`maize_seed_supplier` like '%4%' ) || (`m`.`maize_fertilizer_supplier` <>'' && `m`.`maize_fertilizer_supplier` like '%4%' ) || (`m`.`maize_chemical_supplier` <>'' && `m`.`maize_chemical_supplier` like '%4%' ) || (`m`.`maize_ict_supplier` <>'' && `m`.`maize_ict_supplier` like '%4%' ) || (`m`.`maize_machinery_supplier` <>'' && `m`.`maize_machinery_supplier` like '%4%' ) ), 1, 0 ) ) AS PurchaseMaizeOthersYr2,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,2)."' and ((`m`.`maize_seed_supplier`<>'' && `m`.`maize_seed_supplier` like '%4%' ) || (`m`.`maize_fertilizer_supplier` <>'' && `m`.`maize_fertilizer_supplier` like '%4%' ) || (`m`.`maize_chemical_supplier` <>'' && `m`.`maize_chemical_supplier` like '%4%' ) || (`m`.`maize_ict_supplier` <>'' && `m`.`maize_ict_supplier` like '%4%' ) || (`m`.`maize_machinery_supplier` <>'' && `m`.`maize_machinery_supplier` like '%4%' ) ), 1, 0 ) ) AS PurchaseMaizeOthersYr3,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,3)."' and ((`m`.`maize_seed_supplier`<>'' && `m`.`maize_seed_supplier` like '%4%' ) || (`m`.`maize_fertilizer_supplier` <>'' && `m`.`maize_fertilizer_supplier` like '%4%' ) || (`m`.`maize_chemical_supplier` <>'' && `m`.`maize_chemical_supplier` like '%4%' ) || (`m`.`maize_ict_supplier` <>'' && `m`.`maize_ict_supplier` like '%4%' ) || (`m`.`maize_machinery_supplier` <>'' && `m`.`maize_machinery_supplier` like '%4%' ) ), 1, 0 ) ) AS PurchaseMaizeOthersYr4,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,4)."' and ((`m`.`maize_seed_supplier`<>'' && `m`.`maize_seed_supplier` like '%4%' ) || (`m`.`maize_fertilizer_supplier` <>'' && `m`.`maize_fertilizer_supplier` like '%4%' ) || (`m`.`maize_chemical_supplier` <>'' && `m`.`maize_chemical_supplier` like '%4%' ) || (`m`.`maize_ict_supplier` <>'' && `m`.`maize_ict_supplier` like '%4%' ) || (`m`.`maize_machinery_supplier` <>'' && `m`.`maize_machinery_supplier` like '%4%' ) ), 1, 0 ) ) AS PurchaseMaizeOthersYr5,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,5)."' and ((`m`.`maize_seed_supplier`<>'' && `m`.`maize_seed_supplier` like '%4%' ) || (`m`.`maize_fertilizer_supplier` <>'' && `m`.`maize_fertilizer_supplier` like '%4%' ) || (`m`.`maize_chemical_supplier` <>'' && `m`.`maize_chemical_supplier` like '%4%' ) || (`m`.`maize_ict_supplier` <>'' && `m`.`maize_ict_supplier` like '%4%' ) || (`m`.`maize_machinery_supplier` <>'' && `m`.`maize_machinery_supplier` like '%4%' ) ), 1, 0 ) ) AS PurchaseMaizeOthersYr6
								from `tbl_frm6particulars` as `p`
								join `tbl_frm6production_maize` as `m` on (`m`.`fk_patid`=`p`.`pk_patid`)
								where 24=24";
								$query=@Execute($x4) or die(http("DM-1557"));
								$result=FetchRecords($query);
								$PurchaseMaizeOthersYr1=$result['PurchaseMaizeOthersYr1'];
								$PurchaseMaizeOthersYr2=$result['PurchaseMaizeOthersYr2'];
								$PurchaseMaizeOthersYr3=$result['PurchaseMaizeOthersYr3'];
								$PurchaseMaizeOthersYr4=$result['PurchaseMaizeOthersYr4'];
								$PurchaseMaizeOthersYr5=$result['PurchaseMaizeOthersYr5'];
								$PurchaseMaizeOthersYr6=$result['PurchaseMaizeOthersYr6'];
								
								//-----------------Form6 Beans VARM--------------------------------
								$x5="SELECT 24 as indicator_id,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,0)."' and ((`b`.`beans_seed_supplier`<>'' && `b`.`beans_seed_supplier` like '%1%' ) || (`b`.`beans_fertilizer_supplier` <>'' && `b`.`beans_fertilizer_supplier` like '%1%' ) || (`b`.`beans_chemical_supplier` <>'' && `b`.`beans_chemical_supplier` like '%1%' ) || (`b`.`beans_ict_supplier` <>'' && `b`.`beans_ict_supplier` like '%1%' ) || (`b`.`beans_machinery_supplier` <>'' && `b`.`beans_machinery_supplier` like '%1%' ) ), 1, 0 ) ) AS PurchaseBeansVARMYr1,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,1)."' and ((`b`.`beans_seed_supplier`<>'' && `b`.`beans_seed_supplier` like '%1%' ) || (`b`.`beans_fertilizer_supplier` <>'' && `b`.`beans_fertilizer_supplier` like '%1%' ) || (`b`.`beans_chemical_supplier` <>'' && `b`.`beans_chemical_supplier` like '%1%' ) || (`b`.`beans_ict_supplier` <>'' && `b`.`beans_ict_supplier` like '%1%' ) || (`b`.`beans_machinery_supplier` <>'' && `b`.`beans_machinery_supplier` like '%1%' ) ), 1, 0 ) ) AS PurchaseBeansVARMYr2,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,2)."' and ((`b`.`beans_seed_supplier`<>'' && `b`.`beans_seed_supplier` like '%1%' ) || (`b`.`beans_fertilizer_supplier` <>'' && `b`.`beans_fertilizer_supplier` like '%1%' ) || (`b`.`beans_chemical_supplier` <>'' && `b`.`beans_chemical_supplier` like '%1%' ) || (`b`.`beans_ict_supplier` <>'' && `b`.`beans_ict_supplier` like '%1%' ) || (`b`.`beans_machinery_supplier` <>'' && `b`.`beans_machinery_supplier` like '%1%' ) ), 1, 0 ) ) AS PurchaseBeansVARMYr3,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,3)."' and ((`b`.`beans_seed_supplier`<>'' && `b`.`beans_seed_supplier` like '%1%' ) || (`b`.`beans_fertilizer_supplier` <>'' && `b`.`beans_fertilizer_supplier` like '%1%' ) || (`b`.`beans_chemical_supplier` <>'' && `b`.`beans_chemical_supplier` like '%1%' ) || (`b`.`beans_ict_supplier` <>'' && `b`.`beans_ict_supplier` like '%1%' ) || (`b`.`beans_machinery_supplier` <>'' && `b`.`beans_machinery_supplier` like '%1%' ) ), 1, 0 ) ) AS PurchaseBeansVARMYr4,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,4)."' and ((`b`.`beans_seed_supplier`<>'' && `b`.`beans_seed_supplier` like '%1%' ) || (`b`.`beans_fertilizer_supplier` <>'' && `b`.`beans_fertilizer_supplier` like '%1%' ) || (`b`.`beans_chemical_supplier` <>'' && `b`.`beans_chemical_supplier` like '%1%' ) || (`b`.`beans_ict_supplier` <>'' && `b`.`beans_ict_supplier` like '%1%' ) || (`b`.`beans_machinery_supplier` <>'' && `b`.`beans_machinery_supplier` like '%1%' ) ), 1, 0 ) ) AS PurchaseBeansVARMYr5,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,5)."' and ((`b`.`beans_seed_supplier`<>'' && `b`.`beans_seed_supplier` like '%1%' ) || (`b`.`beans_fertilizer_supplier` <>'' && `b`.`beans_fertilizer_supplier` like '%1%' ) || (`b`.`beans_chemical_supplier` <>'' && `b`.`beans_chemical_supplier` like '%1%' ) || (`b`.`beans_ict_supplier` <>'' && `b`.`beans_ict_supplier` like '%1%' ) || (`b`.`beans_machinery_supplier` <>'' && `b`.`beans_machinery_supplier` like '%1%' ) ), 1, 0 ) ) AS PurchaseBeansVARMYr6
								from `tbl_frm6particulars` as `p`
								join `tbl_frm6production_beans` as `b` on (`b`.`fk_patid`=`p`.`pk_patid`)
								where 24=24";
								$query=@Execute($x5) or die(http("DM-1557"));
								$result=FetchRecords($query);
								$PurchaseBeansVARMYr1=$result['PurchaseBeansVARMYr1'];
								$PurchaseBeansVARMYr2=$result['PurchaseBeansVARMYr2'];
								$PurchaseBeansVARMYr3=$result['PurchaseBeansVARMYr3'];
								$PurchaseBeansVARMYr4=$result['PurchaseBeansVARMYr4'];
								$PurchaseBeansVARMYr5=$result['PurchaseBeansVARMYr5'];
								$PurchaseBeansVARMYr6=$result['PurchaseBeansVARMYr6'];
								
								//-----------------Form6 Beans VA--------------------------------
								$x6="SELECT 24 as indicator_id,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,0)."' and ((`b`.`beans_seed_supplier`<>'' && `b`.`beans_seed_supplier` like '%2%' ) || (`b`.`beans_fertilizer_supplier` <>'' && `b`.`beans_fertilizer_supplier` like '%2%' ) || (`b`.`beans_chemical_supplier` <>'' && `b`.`beans_chemical_supplier` like '%2%' ) || (`b`.`beans_ict_supplier` <>'' && `b`.`beans_ict_supplier` like '%2%' ) || (`b`.`beans_machinery_supplier` <>'' && `b`.`beans_machinery_supplier` like '%2%' ) ), 1, 0 ) ) AS PurchaseBeansVAYr1,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,1)."' and ((`b`.`beans_seed_supplier`<>'' && `b`.`beans_seed_supplier` like '%2%' ) || (`b`.`beans_fertilizer_supplier` <>'' && `b`.`beans_fertilizer_supplier` like '%2%' ) || (`b`.`beans_chemical_supplier` <>'' && `b`.`beans_chemical_supplier` like '%2%' ) || (`b`.`beans_ict_supplier` <>'' && `b`.`beans_ict_supplier` like '%2%' ) || (`b`.`beans_machinery_supplier` <>'' && `b`.`beans_machinery_supplier` like '%2%' ) ), 1, 0 ) ) AS PurchaseBeansVAYr2,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,2)."' and ((`b`.`beans_seed_supplier`<>'' && `b`.`beans_seed_supplier` like '%2%' ) || (`b`.`beans_fertilizer_supplier` <>'' && `b`.`beans_fertilizer_supplier` like '%2%' ) || (`b`.`beans_chemical_supplier` <>'' && `b`.`beans_chemical_supplier` like '%2%' ) || (`b`.`beans_ict_supplier` <>'' && `b`.`beans_ict_supplier` like '%2%' ) || (`b`.`beans_machinery_supplier` <>'' && `b`.`beans_machinery_supplier` like '%2%' ) ), 1, 0 ) ) AS PurchaseBeansVAYr3,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,3)."' and ((`b`.`beans_seed_supplier`<>'' && `b`.`beans_seed_supplier` like '%2%' ) || (`b`.`beans_fertilizer_supplier` <>'' && `b`.`beans_fertilizer_supplier` like '%2%' ) || (`b`.`beans_chemical_supplier` <>'' && `b`.`beans_chemical_supplier` like '%2%' ) || (`b`.`beans_ict_supplier` <>'' && `b`.`beans_ict_supplier` like '%2%' ) || (`b`.`beans_machinery_supplier` <>'' && `b`.`beans_machinery_supplier` like '%2%' ) ), 1, 0 ) ) AS PurchaseBeansVAYr4,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,4)."' and ((`b`.`beans_seed_supplier`<>'' && `b`.`beans_seed_supplier` like '%2%' ) || (`b`.`beans_fertilizer_supplier` <>'' && `b`.`beans_fertilizer_supplier` like '%2%' ) || (`b`.`beans_chemical_supplier` <>'' && `b`.`beans_chemical_supplier` like '%2%' ) || (`b`.`beans_ict_supplier` <>'' && `b`.`beans_ict_supplier` like '%2%' ) || (`b`.`beans_machinery_supplier` <>'' && `b`.`beans_machinery_supplier` like '%2%' ) ), 1, 0 ) ) AS PurchaseBeansVAYr5,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,5)."' and ((`b`.`beans_seed_supplier`<>'' && `b`.`beans_seed_supplier` like '%2%' ) || (`b`.`beans_fertilizer_supplier` <>'' && `b`.`beans_fertilizer_supplier` like '%2%' ) || (`b`.`beans_chemical_supplier` <>'' && `b`.`beans_chemical_supplier` like '%2%' ) || (`b`.`beans_ict_supplier` <>'' && `b`.`beans_ict_supplier` like '%2%' ) || (`b`.`beans_machinery_supplier` <>'' && `b`.`beans_machinery_supplier` like '%2%' ) ), 1, 0 ) ) AS PurchaseBeansVAYr6
								from `tbl_frm6particulars` as `p`
								join `tbl_frm6production_beans` as `b` on (`b`.`fk_patid`=`p`.`pk_patid`)
								where 24=24";
								$query=@Execute($x6) or die(http("DM-1557"));
								$result=FetchRecords($query);
								$PurchaseBeansVAYr1=$result['PurchaseBeansVAYr1'];
								$PurchaseBeansVAYr2=$result['PurchaseBeansVAYr2'];
								$PurchaseBeansVAYr3=$result['PurchaseBeansVAYr3'];
								$PurchaseBeansVAYr4=$result['PurchaseBeansVAYr4'];
								$PurchaseBeansVAYr5=$result['PurchaseBeansVAYr5'];
								$PurchaseBeansVAYr6=$result['PurchaseBeansVAYr6'];
								
								//-----------------Form6 Beans Stockist--------------------------------
								$x7="SELECT 24 as indicator_id,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,0)."' and ((`b`.`beans_seed_supplier`<>'' && `b`.`beans_seed_supplier` like '%3%' ) || (`b`.`beans_fertilizer_supplier` <>'' && `b`.`beans_fertilizer_supplier` like '%3%' ) || (`b`.`beans_chemical_supplier` <>'' && `b`.`beans_chemical_supplier` like '%3%' ) || (`b`.`beans_ict_supplier` <>'' && `b`.`beans_ict_supplier` like '%3%' ) || (`b`.`beans_machinery_supplier` <>'' && `b`.`beans_machinery_supplier` like '%3%' ) ), 1, 0 ) ) AS PurchaseBeansStockistYr1,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,1)."' and ((`b`.`beans_seed_supplier`<>'' && `b`.`beans_seed_supplier` like '%3%' ) || (`b`.`beans_fertilizer_supplier` <>'' && `b`.`beans_fertilizer_supplier` like '%3%' ) || (`b`.`beans_chemical_supplier` <>'' && `b`.`beans_chemical_supplier` like '%3%' ) || (`b`.`beans_ict_supplier` <>'' && `b`.`beans_ict_supplier` like '%3%' ) || (`b`.`beans_machinery_supplier` <>'' && `b`.`beans_machinery_supplier` like '%3%' ) ), 1, 0 ) ) AS PurchaseBeansStockistYr2,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,2)."' and ((`b`.`beans_seed_supplier`<>'' && `b`.`beans_seed_supplier` like '%3%' ) || (`b`.`beans_fertilizer_supplier` <>'' && `b`.`beans_fertilizer_supplier` like '%3%' ) || (`b`.`beans_chemical_supplier` <>'' && `b`.`beans_chemical_supplier` like '%3%' ) || (`b`.`beans_ict_supplier` <>'' && `b`.`beans_ict_supplier` like '%3%' ) || (`b`.`beans_machinery_supplier` <>'' && `b`.`beans_machinery_supplier` like '%3%' ) ), 1, 0 ) ) AS PurchaseBeansStockistYr3,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,3)."' and ((`b`.`beans_seed_supplier`<>'' && `b`.`beans_seed_supplier` like '%3%' ) || (`b`.`beans_fertilizer_supplier` <>'' && `b`.`beans_fertilizer_supplier` like '%3%' ) || (`b`.`beans_chemical_supplier` <>'' && `b`.`beans_chemical_supplier` like '%3%' ) || (`b`.`beans_ict_supplier` <>'' && `b`.`beans_ict_supplier` like '%3%' ) || (`b`.`beans_machinery_supplier` <>'' && `b`.`beans_machinery_supplier` like '%3%' ) ), 1, 0 ) ) AS PurchaseBeansStockistYr4,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,4)."' and ((`b`.`beans_seed_supplier`<>'' && `b`.`beans_seed_supplier` like '%3%' ) || (`b`.`beans_fertilizer_supplier` <>'' && `b`.`beans_fertilizer_supplier` like '%3%' ) || (`b`.`beans_chemical_supplier` <>'' && `b`.`beans_chemical_supplier` like '%3%' ) || (`b`.`beans_ict_supplier` <>'' && `b`.`beans_ict_supplier` like '%3%' ) || (`b`.`beans_machinery_supplier` <>'' && `b`.`beans_machinery_supplier` like '%3%' ) ), 1, 0 ) ) AS PurchaseBeansStockistYr5,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,5)."' and ((`b`.`beans_seed_supplier`<>'' && `b`.`beans_seed_supplier` like '%3%' ) || (`b`.`beans_fertilizer_supplier` <>'' && `b`.`beans_fertilizer_supplier` like '%3%' ) || (`b`.`beans_chemical_supplier` <>'' && `b`.`beans_chemical_supplier` like '%3%' ) || (`b`.`beans_ict_supplier` <>'' && `b`.`beans_ict_supplier` like '%3%' ) || (`b`.`beans_machinery_supplier` <>'' && `b`.`beans_machinery_supplier` like '%3%' ) ), 1, 0 ) ) AS PurchaseBeansStockistYr6
								from `tbl_frm6particulars` as `p`
								join `tbl_frm6production_beans` as `b` on (`b`.`fk_patid`=`p`.`pk_patid`)
								where 24=24";
								$query=@Execute($x7) or die(http("DM-1557"));
								$result=FetchRecords($query);
								$PurchaseBeansStockistYr1=$result['PurchaseBeansStockistYr1'];
								$PurchaseBeansStockistYr2=$result['PurchaseBeansStockistYr2'];
								$PurchaseBeansStockistYr3=$result['PurchaseBeansStockistYr3'];
								$PurchaseBeansStockistYr4=$result['PurchaseBeansStockistYr4'];
								$PurchaseBeansStockistYr5=$result['PurchaseBeansStockistYr5'];
								$PurchaseBeansStockistYr6=$result['PurchaseBeansStockistYr6'];
								
								//-----------------Form6 Beans Others--------------------------------
								$x8="SELECT 24 as indicator_id,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,0)."' and ((`b`.`beans_seed_supplier`<>'' && `b`.`beans_seed_supplier` like '%4%' ) || (`b`.`beans_fertilizer_supplier` <>'' && `b`.`beans_fertilizer_supplier` like '%4%' ) || (`b`.`beans_chemical_supplier` <>'' && `b`.`beans_chemical_supplier` like '%4%' ) || (`b`.`beans_ict_supplier` <>'' && `b`.`beans_ict_supplier` like '%4%' ) || (`b`.`beans_machinery_supplier` <>'' && `b`.`beans_machinery_supplier` like '%4%' ) ), 1, 0 ) ) AS PurchaseBeansOthersYr1,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,1)."' and ((`b`.`beans_seed_supplier`<>'' && `b`.`beans_seed_supplier` like '%4%' ) || (`b`.`beans_fertilizer_supplier` <>'' && `b`.`beans_fertilizer_supplier` like '%4%' ) || (`b`.`beans_chemical_supplier` <>'' && `b`.`beans_chemical_supplier` like '%4%' ) || (`b`.`beans_ict_supplier` <>'' && `b`.`beans_ict_supplier` like '%4%' ) || (`b`.`beans_machinery_supplier` <>'' && `b`.`beans_machinery_supplier` like '%4%' ) ), 1, 0 ) ) AS PurchaseBeansOthersYr2,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,2)."' and ((`b`.`beans_seed_supplier`<>'' && `b`.`beans_seed_supplier` like '%4%' ) || (`b`.`beans_fertilizer_supplier` <>'' && `b`.`beans_fertilizer_supplier` like '%4%' ) || (`b`.`beans_chemical_supplier` <>'' && `b`.`beans_chemical_supplier` like '%4%' ) || (`b`.`beans_ict_supplier` <>'' && `b`.`beans_ict_supplier` like '%4%' ) || (`b`.`beans_machinery_supplier` <>'' && `b`.`beans_machinery_supplier` like '%4%' ) ), 1, 0 ) ) AS PurchaseBeansOthersYr3,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,3)."' and ((`b`.`beans_seed_supplier`<>'' && `b`.`beans_seed_supplier` like '%4%' ) || (`b`.`beans_fertilizer_supplier` <>'' && `b`.`beans_fertilizer_supplier` like '%4%' ) || (`b`.`beans_chemical_supplier` <>'' && `b`.`beans_chemical_supplier` like '%4%' ) || (`b`.`beans_ict_supplier` <>'' && `b`.`beans_ict_supplier` like '%4%' ) || (`b`.`beans_machinery_supplier` <>'' && `b`.`beans_machinery_supplier` like '%4%' ) ), 1, 0 ) ) AS PurchaseBeansOthersYr4,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,4)."' and ((`b`.`beans_seed_supplier`<>'' && `b`.`beans_seed_supplier` like '%4%' ) || (`b`.`beans_fertilizer_supplier` <>'' && `b`.`beans_fertilizer_supplier` like '%4%' ) || (`b`.`beans_chemical_supplier` <>'' && `b`.`beans_chemical_supplier` like '%4%' ) || (`b`.`beans_ict_supplier` <>'' && `b`.`beans_ict_supplier` like '%4%' ) || (`b`.`beans_machinery_supplier` <>'' && `b`.`beans_machinery_supplier` like '%4%' ) ), 1, 0 ) ) AS PurchaseBeansOthersYr5,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,5)."' and ((`b`.`beans_seed_supplier`<>'' && `b`.`beans_seed_supplier` like '%4%' ) || (`b`.`beans_fertilizer_supplier` <>'' && `b`.`beans_fertilizer_supplier` like '%4%' ) || (`b`.`beans_chemical_supplier` <>'' && `b`.`beans_chemical_supplier` like '%4%' ) || (`b`.`beans_ict_supplier` <>'' && `b`.`beans_ict_supplier` like '%4%' ) || (`b`.`beans_machinery_supplier` <>'' && `b`.`beans_machinery_supplier` like '%4%' ) ), 1, 0 ) ) AS PurchaseBeansOthersYr6
								from `tbl_frm6particulars` as `p`
								join `tbl_frm6production_beans` as `b` on (`b`.`fk_patid`=`p`.`pk_patid`)
								where 24=24";
								$query=@Execute($x8) or die(http("DM-1557"));
								$result=FetchRecords($query);
								$PurchaseBeansOthersYr1=$result['PurchaseBeansOthersYr1'];
								$PurchaseBeansOthersYr2=$result['PurchaseBeansOthersYr2'];
								$PurchaseBeansOthersYr3=$result['PurchaseBeansOthersYr3'];
								$PurchaseBeansOthersYr4=$result['PurchaseBeansOthersYr4'];
								$PurchaseBeansOthersYr5=$result['PurchaseBeansOthersYr5'];
								
								//-----------------Form6 Coffee VARM--------------------------------
								$x9="SELECT 24 as indicator_id,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,0)."' and ((`c`.`coffee_seed_supplier`<>'' && `c`.`coffee_seed_supplier` like '%1%' ) || (`c`.`coffee_fertilizer_supplier` <>'' && `c`.`coffee_fertilizer_supplier` like '%1%' ) || (`c`.`coffee_chemical_supplier` <>'' && `c`.`coffee_chemical_supplier` like '%1%' ) || (`c`.`coffee_ict_supplier` <>'' && `c`.`coffee_ict_supplier` like '%1%' ) || (`c`.`coffee_machinery_supplier` <>'' && `c`.`coffee_machinery_supplier` like '%1%' ) ), 1, 0 ) ) AS PurchaseCoffeeVARMYr1,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,1)."' and ((`c`.`coffee_seed_supplier`<>'' && `c`.`coffee_seed_supplier` like '%1%' ) || (`c`.`coffee_fertilizer_supplier` <>'' && `c`.`coffee_fertilizer_supplier` like '%1%' ) || (`c`.`coffee_chemical_supplier` <>'' && `c`.`coffee_chemical_supplier` like '%1%' ) || (`c`.`coffee_ict_supplier` <>'' && `c`.`coffee_ict_supplier` like '%1%' ) || (`c`.`coffee_machinery_supplier` <>'' && `c`.`coffee_machinery_supplier` like '%1%' ) ), 1, 0 ) ) AS PurchaseCoffeeVARMYr2,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,2)."' and ((`c`.`coffee_seed_supplier`<>'' && `c`.`coffee_seed_supplier` like '%1%' ) || (`c`.`coffee_fertilizer_supplier` <>'' && `c`.`coffee_fertilizer_supplier` like '%1%' ) || (`c`.`coffee_chemical_supplier` <>'' && `c`.`coffee_chemical_supplier` like '%1%' ) || (`c`.`coffee_ict_supplier` <>'' && `c`.`coffee_ict_supplier` like '%1%' ) || (`c`.`coffee_machinery_supplier` <>'' && `c`.`coffee_machinery_supplier` like '%1%' ) ), 1, 0 ) ) AS PurchaseCoffeeVARMYr3,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,3)."' and ((`c`.`coffee_seed_supplier`<>'' && `c`.`coffee_seed_supplier` like '%1%' ) || (`c`.`coffee_fertilizer_supplier` <>'' && `c`.`coffee_fertilizer_supplier` like '%1%' ) || (`c`.`coffee_chemical_supplier` <>'' && `c`.`coffee_chemical_supplier` like '%1%' ) || (`c`.`coffee_ict_supplier` <>'' && `c`.`coffee_ict_supplier` like '%1%' ) || (`c`.`coffee_machinery_supplier` <>'' && `c`.`coffee_machinery_supplier` like '%1%' ) ), 1, 0 ) ) AS PurchaseCoffeeVARMYr4,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,4)."' and ((`c`.`coffee_seed_supplier`<>'' && `c`.`coffee_seed_supplier` like '%1%' ) || (`c`.`coffee_fertilizer_supplier` <>'' && `c`.`coffee_fertilizer_supplier` like '%1%' ) || (`c`.`coffee_chemical_supplier` <>'' && `c`.`coffee_chemical_supplier` like '%1%' ) || (`c`.`coffee_ict_supplier` <>'' && `c`.`coffee_ict_supplier` like '%1%' ) || (`c`.`coffee_machinery_supplier` <>'' && `c`.`coffee_machinery_supplier` like '%1%' ) ), 1, 0 ) ) AS PurchaseCoffeeVARMYr5,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,5)."' and ((`c`.`coffee_seed_supplier`<>'' && `c`.`coffee_seed_supplier` like '%1%' ) || (`c`.`coffee_fertilizer_supplier` <>'' && `c`.`coffee_fertilizer_supplier` like '%1%' ) || (`c`.`coffee_chemical_supplier` <>'' && `c`.`coffee_chemical_supplier` like '%1%' ) || (`c`.`coffee_ict_supplier` <>'' && `c`.`coffee_ict_supplier` like '%1%' ) || (`c`.`coffee_machinery_supplier` <>'' && `c`.`coffee_machinery_supplier` like '%1%' ) ), 1, 0 ) ) AS PurchaseCoffeeVARMYr6
								from `tbl_frm6particulars` as `p`
								join `tbl_frm6production_coffee` as `c` on (`c`.`fk_patid`=`p`.`pk_patid`)
								where 24=24";
								$query=@Execute($x9) or die(http("DM-1557"));
								$result=FetchRecords($query);
								$PurchaseCoffeeVARMYr1=$result['PurchaseCoffeeVARMYr1'];
								$PurchaseCoffeeVARMYr2=$result['PurchaseCoffeeVARMYr2'];
								$PurchaseCoffeeVARMYr3=$result['PurchaseCoffeeVARMYr3'];
								$PurchaseCoffeeVARMYr4=$result['PurchaseCoffeeVARMYr4'];
								$PurchaseCoffeeVARMYr5=$result['PurchaseCoffeeVARMYr5'];
								$PurchaseCoffeeVARMYr6=$result['PurchaseCoffeeVARMYr6'];
								
								//-----------------Form6 Coffee VA--------------------------------
								$x10="SELECT 24 as indicator_id,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,0)."' and ((`c`.`coffee_seed_supplier`<>'' && `c`.`coffee_seed_supplier` like '%2%' ) || (`c`.`coffee_fertilizer_supplier` <>'' && `c`.`coffee_fertilizer_supplier` like '%2%' ) || (`c`.`coffee_chemical_supplier` <>'' && `c`.`coffee_chemical_supplier` like '%2%' ) || (`c`.`coffee_ict_supplier` <>'' && `c`.`coffee_ict_supplier` like '%2%' ) || (`c`.`coffee_machinery_supplier` <>'' && `c`.`coffee_machinery_supplier` like '%2%' ) ), 1, 0 ) ) AS PurchaseCoffeeVAYr1,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,1)."' and ((`c`.`coffee_seed_supplier`<>'' && `c`.`coffee_seed_supplier` like '%2%' ) || (`c`.`coffee_fertilizer_supplier` <>'' && `c`.`coffee_fertilizer_supplier` like '%2%' ) || (`c`.`coffee_chemical_supplier` <>'' && `c`.`coffee_chemical_supplier` like '%2%' ) || (`c`.`coffee_ict_supplier` <>'' && `c`.`coffee_ict_supplier` like '%2%' ) || (`c`.`coffee_machinery_supplier` <>'' && `c`.`coffee_machinery_supplier` like '%2%' ) ), 1, 0 ) ) AS PurchaseCoffeeVAYr2,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,2)."' and ((`c`.`coffee_seed_supplier`<>'' && `c`.`coffee_seed_supplier` like '%2%' ) || (`c`.`coffee_fertilizer_supplier` <>'' && `c`.`coffee_fertilizer_supplier` like '%2%' ) || (`c`.`coffee_chemical_supplier` <>'' && `c`.`coffee_chemical_supplier` like '%2%' ) || (`c`.`coffee_ict_supplier` <>'' && `c`.`coffee_ict_supplier` like '%2%' ) || (`c`.`coffee_machinery_supplier` <>'' && `c`.`coffee_machinery_supplier` like '%2%' ) ), 1, 0 ) ) AS PurchaseCoffeeVAYr3,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,3)."' and ((`c`.`coffee_seed_supplier`<>'' && `c`.`coffee_seed_supplier` like '%2%' ) || (`c`.`coffee_fertilizer_supplier` <>'' && `c`.`coffee_fertilizer_supplier` like '%2%' ) || (`c`.`coffee_chemical_supplier` <>'' && `c`.`coffee_chemical_supplier` like '%2%' ) || (`c`.`coffee_ict_supplier` <>'' && `c`.`coffee_ict_supplier` like '%2%' ) || (`c`.`coffee_machinery_supplier` <>'' && `c`.`coffee_machinery_supplier` like '%2%' ) ), 1, 0 ) ) AS PurchaseCoffeeVAYr4,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,4)."' and ((`c`.`coffee_seed_supplier`<>'' && `c`.`coffee_seed_supplier` like '%2%' ) || (`c`.`coffee_fertilizer_supplier` <>'' && `c`.`coffee_fertilizer_supplier` like '%2%' ) || (`c`.`coffee_chemical_supplier` <>'' && `c`.`coffee_chemical_supplier` like '%2%' ) || (`c`.`coffee_ict_supplier` <>'' && `c`.`coffee_ict_supplier` like '%2%' ) || (`c`.`coffee_machinery_supplier` <>'' && `c`.`coffee_machinery_supplier` like '%2%' ) ), 1, 0 ) ) AS PurchaseCoffeeVAYr5,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,5)."' and ((`c`.`coffee_seed_supplier`<>'' && `c`.`coffee_seed_supplier` like '%2%' ) || (`c`.`coffee_fertilizer_supplier` <>'' && `c`.`coffee_fertilizer_supplier` like '%2%' ) || (`c`.`coffee_chemical_supplier` <>'' && `c`.`coffee_chemical_supplier` like '%2%' ) || (`c`.`coffee_ict_supplier` <>'' && `c`.`coffee_ict_supplier` like '%2%' ) || (`c`.`coffee_machinery_supplier` <>'' && `c`.`coffee_machinery_supplier` like '%2%' ) ), 1, 0 ) ) AS PurchaseCoffeeVAYr6
								from `tbl_frm6particulars` as `p`
								join `tbl_frm6production_coffee` as `c` on (`c`.`fk_patid`=`p`.`pk_patid`)
								where 24=24";
								$query=@Execute($x10) or die(http("DM-1557"));
								$result=FetchRecords($query);
								$PurchaseCoffeeVAYr1=$result['PurchaseCoffeeVAYr1'];
								$PurchaseCoffeeVAYr2=$result['PurchaseCoffeeVAYr2'];
								$PurchaseCoffeeVAYr3=$result['PurchaseCoffeeVAYr3'];
								$PurchaseCoffeeVAYr4=$result['PurchaseCoffeeVAYr4'];
								$PurchaseCoffeeVAYr5=$result['PurchaseCoffeeVAYr5'];
								$PurchaseCoffeeVAYr6=$result['PurchaseCoffeeVAYr6'];
								
								//-----------------Form6 Coffee Stockist--------------------------------
								$x11="SELECT 24 as indicator_id,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,0)."' and ((`c`.`coffee_seed_supplier`<>'' && `c`.`coffee_seed_supplier` like '%3%' ) || (`c`.`coffee_fertilizer_supplier` <>'' && `c`.`coffee_fertilizer_supplier` like '%3%' ) || (`c`.`coffee_chemical_supplier` <>'' && `c`.`coffee_chemical_supplier` like '%3%' ) || (`c`.`coffee_ict_supplier` <>'' && `c`.`coffee_ict_supplier` like '%3%' ) || (`c`.`coffee_machinery_supplier` <>'' && `c`.`coffee_machinery_supplier` like '%3%' ) ), 1, 0 ) ) AS PurchaseCoffeeStockistYr1,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,1)."' and ((`c`.`coffee_seed_supplier`<>'' && `c`.`coffee_seed_supplier` like '%3%' ) || (`c`.`coffee_fertilizer_supplier` <>'' && `c`.`coffee_fertilizer_supplier` like '%3%' ) || (`c`.`coffee_chemical_supplier` <>'' && `c`.`coffee_chemical_supplier` like '%3%' ) || (`c`.`coffee_ict_supplier` <>'' && `c`.`coffee_ict_supplier` like '%3%' ) || (`c`.`coffee_machinery_supplier` <>'' && `c`.`coffee_machinery_supplier` like '%3%' ) ), 1, 0 ) ) AS PurchaseCoffeeStockistYr2,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,2)."' and ((`c`.`coffee_seed_supplier`<>'' && `c`.`coffee_seed_supplier` like '%3%' ) || (`c`.`coffee_fertilizer_supplier` <>'' && `c`.`coffee_fertilizer_supplier` like '%3%' ) || (`c`.`coffee_chemical_supplier` <>'' && `c`.`coffee_chemical_supplier` like '%3%' ) || (`c`.`coffee_ict_supplier` <>'' && `c`.`coffee_ict_supplier` like '%3%' ) || (`c`.`coffee_machinery_supplier` <>'' && `c`.`coffee_machinery_supplier` like '%3%' ) ), 1, 0 ) ) AS PurchaseCoffeeStockistYr3,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,3)."' and ((`c`.`coffee_seed_supplier`<>'' && `c`.`coffee_seed_supplier` like '%3%' ) || (`c`.`coffee_fertilizer_supplier` <>'' && `c`.`coffee_fertilizer_supplier` like '%3%' ) || (`c`.`coffee_chemical_supplier` <>'' && `c`.`coffee_chemical_supplier` like '%3%' ) || (`c`.`coffee_ict_supplier` <>'' && `c`.`coffee_ict_supplier` like '%3%' ) || (`c`.`coffee_machinery_supplier` <>'' && `c`.`coffee_machinery_supplier` like '%3%' ) ), 1, 0 ) ) AS PurchaseCoffeeStockistYr4,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,4)."' and ((`c`.`coffee_seed_supplier`<>'' && `c`.`coffee_seed_supplier` like '%3%' ) || (`c`.`coffee_fertilizer_supplier` <>'' && `c`.`coffee_fertilizer_supplier` like '%3%' ) || (`c`.`coffee_chemical_supplier` <>'' && `c`.`coffee_chemical_supplier` like '%3%' ) || (`c`.`coffee_ict_supplier` <>'' && `c`.`coffee_ict_supplier` like '%3%' ) || (`c`.`coffee_machinery_supplier` <>'' && `c`.`coffee_machinery_supplier` like '%3%' ) ), 1, 0 ) ) AS PurchaseCoffeeStockistYr5,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,5)."' and ((`c`.`coffee_seed_supplier`<>'' && `c`.`coffee_seed_supplier` like '%3%' ) || (`c`.`coffee_fertilizer_supplier` <>'' && `c`.`coffee_fertilizer_supplier` like '%3%' ) || (`c`.`coffee_chemical_supplier` <>'' && `c`.`coffee_chemical_supplier` like '%3%' ) || (`c`.`coffee_ict_supplier` <>'' && `c`.`coffee_ict_supplier` like '%3%' ) || (`c`.`coffee_machinery_supplier` <>'' && `c`.`coffee_machinery_supplier` like '%3%' ) ), 1, 0 ) ) AS PurchaseCoffeeStockistYr6
								from `tbl_frm6particulars` as `p`
								join `tbl_frm6production_coffee` as `c` on (`c`.`fk_patid`=`p`.`pk_patid`)
								where 24=24";
								$query=@Execute($x11) or die(http("DM-1557"));
								$result=FetchRecords($query);
								$PurchaseCoffeeStockistYr1=$result['PurchaseCoffeeStockistYr1'];
								$PurchaseCoffeeStockistYr2=$result['PurchaseCoffeeStockistYr2'];
								$PurchaseCoffeeStockistYr3=$result['PurchaseCoffeeStockistYr3'];
								$PurchaseCoffeeStockistYr4=$result['PurchaseCoffeeStockistYr4'];
								$PurchaseCoffeeStockistYr5=$result['PurchaseCoffeeStockistYr5'];
								$PurchaseCoffeeStockistYr6=$result['PurchaseCoffeeStockistYr6'];
								
								//-----------------Form6 Coffee Others--------------------------------
								$x12="SELECT 24 as indicator_id,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,0)."' and ((`c`.`coffee_seed_supplier`<>'' && `c`.`coffee_seed_supplier` like '%4%' ) || (`c`.`coffee_fertilizer_supplier` <>'' && `c`.`coffee_fertilizer_supplier` like '%4%' ) || (`c`.`coffee_chemical_supplier` <>'' && `c`.`coffee_chemical_supplier` like '%4%' ) || (`c`.`coffee_ict_supplier` <>'' && `c`.`coffee_ict_supplier` like '%4%' ) || (`c`.`coffee_machinery_supplier` <>'' && `c`.`coffee_machinery_supplier` like '%4%' ) ), 1, 0 ) ) AS PurchaseCoffeeOthersYr1,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,1)."' and ((`c`.`coffee_seed_supplier`<>'' && `c`.`coffee_seed_supplier` like '%4%' ) || (`c`.`coffee_fertilizer_supplier` <>'' && `c`.`coffee_fertilizer_supplier` like '%4%' ) || (`c`.`coffee_chemical_supplier` <>'' && `c`.`coffee_chemical_supplier` like '%4%' ) || (`c`.`coffee_ict_supplier` <>'' && `c`.`coffee_ict_supplier` like '%4%' ) || (`c`.`coffee_machinery_supplier` <>'' && `c`.`coffee_machinery_supplier` like '%4%' ) ), 1, 0 ) ) AS PurchaseCoffeeOthersYr2,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,2)."' and ((`c`.`coffee_seed_supplier`<>'' && `c`.`coffee_seed_supplier` like '%4%' ) || (`c`.`coffee_fertilizer_supplier` <>'' && `c`.`coffee_fertilizer_supplier` like '%4%' ) || (`c`.`coffee_chemical_supplier` <>'' && `c`.`coffee_chemical_supplier` like '%4%' ) || (`c`.`coffee_ict_supplier` <>'' && `c`.`coffee_ict_supplier` like '%4%' ) || (`c`.`coffee_machinery_supplier` <>'' && `c`.`coffee_machinery_supplier` like '%4%' ) ), 1, 0 ) ) AS PurchaseCoffeeOthersYr3,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,3)."' and ((`c`.`coffee_seed_supplier`<>'' && `c`.`coffee_seed_supplier` like '%4%' ) || (`c`.`coffee_fertilizer_supplier` <>'' && `c`.`coffee_fertilizer_supplier` like '%4%' ) || (`c`.`coffee_chemical_supplier` <>'' && `c`.`coffee_chemical_supplier` like '%4%' ) || (`c`.`coffee_ict_supplier` <>'' && `c`.`coffee_ict_supplier` like '%4%' ) || (`c`.`coffee_machinery_supplier` <>'' && `c`.`coffee_machinery_supplier` like '%4%' ) ), 1, 0 ) ) AS PurchaseCoffeeOthersYr4,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,4)."' and ((`c`.`coffee_seed_supplier`<>'' && `c`.`coffee_seed_supplier` like '%4%' ) || (`c`.`coffee_fertilizer_supplier` <>'' && `c`.`coffee_fertilizer_supplier` like '%4%' ) || (`c`.`coffee_chemical_supplier` <>'' && `c`.`coffee_chemical_supplier` like '%4%' ) || (`c`.`coffee_ict_supplier` <>'' && `c`.`coffee_ict_supplier` like '%4%' ) || (`c`.`coffee_machinery_supplier` <>'' && `c`.`coffee_machinery_supplier` like '%4%' ) ), 1, 0 ) ) AS PurchaseCoffeeOthersYr5,
								sum( if( substr( `p`.`interview_date`, 1, 4 ) = '".TheFinancialYear($opening_year,$closure_year,5)."' and ((`c`.`coffee_seed_supplier`<>'' && `c`.`coffee_seed_supplier` like '%4%' ) || (`c`.`coffee_fertilizer_supplier` <>'' && `c`.`coffee_fertilizer_supplier` like '%4%' ) || (`c`.`coffee_chemical_supplier` <>'' && `c`.`coffee_chemical_supplier` like '%4%' ) || (`c`.`coffee_ict_supplier` <>'' && `c`.`coffee_ict_supplier` like '%4%' ) || (`c`.`coffee_machinery_supplier` <>'' && `c`.`coffee_machinery_supplier` like '%4%' ) ), 1, 0 ) ) AS PurchaseCoffeeOthersYr6
								from `tbl_frm6particulars` as `p`
								join `tbl_frm6production_coffee` as `c` on (`c`.`fk_patid`=`p`.`pk_patid`)
								where 24=24";
								$query=@Execute($x12) or die(http("DM-1557"));
								$result=FetchRecords($query);
								$PurchaseCoffeeOthersYr1=$result['PurchaseCoffeeOthersYr1'];
								$PurchaseCoffeeOthersYr2=$result['PurchaseCoffeeOthersYr2'];
								$PurchaseCoffeeOthersYr3=$result['PurchaseCoffeeOthersYr3'];
								$PurchaseCoffeeOthersYr4=$result['PurchaseCoffeeOthersYr4'];
								$PurchaseCoffeeOthersYr5=$result['PurchaseCoffeeOthersYr5'];
								$PurchaseCoffeeOthersYr6=$result['PurchaseCoffeeOthersYr6'];
								...
								//SUMMING UP THE FARMERS WHO have purchased Inputs
								$purchasingInputsYr1= $PurchaseMaizeVARMYr1+ $PurchaseMaizeVAYr1 + $PurchaseMaizeStockistYr1 + $PurchaseMaizeOthersYr1 + $PurchaseBeansVARMYr1+ $PurchaseBeansVAYr1 + $PurchaseBeansStockistYr1 + $PurchaseBeansOthersYr1 + $PurchaseCoffeeVARMYr1 + $PurchaseCoffeeVAYr1 + $PurchaseCoffeeStockistYr1 + $PurchaseCoffeeOthersYr1;
								$purchasingInputsYr2= $PurchaseMaizeVARMYr2+ $PurchaseMaizeVAYr2 + $PurchaseMaizeStockistYr2 + $PurchaseMaizeOthersYr2 + $PurchaseBeansVARMYr2+ $PurchaseBeansVAYr2 + $PurchaseBeansStockistYr2 + $PurchaseBeansOthersYr2 + $PurchaseCoffeeVARMYr2 + $PurchaseCoffeeVAYr2 + $PurchaseCoffeeStockistYr2 + $PurchaseCoffeeOthersYr2;
								$purchasingInputsYr3= $PurchaseMaizeVARMYr3+ $PurchaseMaizeVAYr3 + $PurchaseMaizeStockistYr3 + $PurchaseMaizeOthersYr3 + $PurchaseBeansVARMYr3+ $PurchaseBeansVAYr3 + $PurchaseBeansStockistYr3 + $PurchaseBeansOthersYr3 + $PurchaseCoffeeVARMYr3 + $PurchaseCoffeeVAYr3 + $PurchaseCoffeeStockistYr3 + $PurchaseCoffeeOthersYr3;
								$purchasingInputsYr4= $PurchaseMaizeVARMYr4+ $PurchaseMaizeVAYr4 + $PurchaseMaizeStockistYr4 + $PurchaseMaizeOthersYr4 + $PurchaseBeansVARMYr4+ $PurchaseBeansVAYr4 + $PurchaseBeansStockistYr4 + $PurchaseBeansOthersYr4 + $PurchaseCoffeeVARMYr4 + $PurchaseCoffeeVAYr4 + $PurchaseCoffeeStockistYr4 + $PurchaseCoffeeOthersYr4;
								$purchasingInputsYr5= $PurchaseMaizeVARMYr5+ $PurchaseMaizeVAYr5 + $PurchaseMaizeStockistYr5 + $PurchaseMaizeOthersYr5 + $PurchaseBeansVARMYr5+ $PurchaseBeansVAYr5 + $PurchaseBeansStockistYr5 + $PurchaseBeansOthersYr5 + $PurchaseCoffeeVARMYr5 + $PurchaseCoffeeVAYr5 + $PurchaseCoffeeStockistYr5 + $PurchaseCoffeeOthersYr5;
								$purchasingInputsYr6= $PurchaseMaizeVARMYr6+ $PurchaseMaizeVAYr6 + $PurchaseMaizeStockistYr6 + $PurchaseMaizeOthersYr6 + $PurchaseBeansVARMYr6+ $PurchaseBeansVAYr6 + $PurchaseBeansStockistYr6 + $PurchaseBeansOthersYr6 + $PurchaseCoffeeVARMYr6 + $PurchaseCoffeeVAYr6 + $PurchaseCoffeeStockistYr6 + $PurchaseCoffeeOthersYr6;

								$result['notrainedYr1']=convertToPercentages($purchasingInputsYr1,$TotNumFarmersSurveyedYr1);
								$result['notrainedYr2']=convertToPercentages($purchasingInputsYr2,$TotNumFarmersSurveyedYr2);
								$result['notrainedYr3']=convertToPercentages($purchasingInputsYr3,$TotNumFarmersSurveyedYr3);
								$result['notrainedYr4']=convertToPercentages($purchasingInputsYr4,$TotNumFarmersSurveyedYr4);
								$result['notrainedYr5']=convertToPercentages($purchasingInputsYr5,$TotNumFarmersSurveyedYr5);
								$result['notrainedYr6']=convertToPercentages($purchasingInputsYr6,$TotNumFarmersSurveyedYr6);
								return $result[$resultValue];
							}
