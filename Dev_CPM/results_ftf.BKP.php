...
$data.="<form name='annualTarget1' id='annualTarget1' action=\"".$PHP_SELF."\" method='post'><table cellspacing='1'  id='report' width='100%' >
".filter_ftfReport($fnctName="ftfReport");
//
		...
		<th colspan='27' class='dataRow' ><center>Feed the Future Report for the Period 2013 - 2018 <em>, LOA=Life of Activity, T=Target,A=Actual, % Achieved=>((A/T)x100)</em></center></th>
