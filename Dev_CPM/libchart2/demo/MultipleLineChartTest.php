   ...
   @mysql_select_db(DB_NAME,mysql_connect(DB_SERVER,DB_USER,DB_PWD))or die(@http("Connection Failure!-LIB-0047"));
	 ...
	 */
	 	 ...
	 	 $data_110 = $_GET['indicator_id'];
			...
			$year=$_GET['year'];
	 		$Quarter1=$_GET['Quarter1'];
			$Quarter2=$_GET['Quarter2'];
			$Quarter3=$_GET['Quarter3'];
			$Quarter4=$_GET['Quarter4'];
			$ActualQuarter1=$_GET['ActualQuarter1'];
			$ActualQuarter2=$_GET['ActualQuarter2'];
			$ActualQuarter3=$_GET['ActualQuarter3'];
			$ActualQuarter4=$_GET['ActualQuarter4'];
	...
	$serie1->addPoint(new Point("Jan - Mar", $Quarter1));
	$serie1->addPoint(new Point("Apr - Jun", $Quarter2));
	$serie1->addPoint(new Point("Jul - Sep", $Quarter3));
	$serie1->addPoint(new Point("Oct - Dec", $Quarter4));
	$serie1->addPoint(new Point("Total", $data_11));
	
	$serie2 = new XYDataSet();
	
	$serie2->addPoint(new Point("Jan - Mar", $ActualQuarter1));
	$serie2->addPoint(new Point("Apr - Jun", $ActualQuarter2));
	$serie2->addPoint(new Point("Jul - Sep", $ActualQuarter3));
	$serie2->addPoint(new Point("Oct - Dec", $ActualQuarter4));
	$serie2->addPoint(new Point("Total", $data_21)); 
	...
	$serie4->addPoint(new Point($year." Total Target", $data_11));
	...
	$serie5->addPoint(new Point($year." Total Actual", $data_21));
	...
	$dataSet->addSerie($year." Target", $serie1);
	$dataSet->addSerie($year." Actual", $serie2);
