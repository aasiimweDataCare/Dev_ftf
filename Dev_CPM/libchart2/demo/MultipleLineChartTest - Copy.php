...
require_once('conf.php');
   @mysql_select_db(DB_NAME,mysql_connect(DB_SERVER,DB_USER,DB_PWD))or die(@http("Connection Failure!-LIB-0047"));
	...
	# $serie1->addPoint(new Point($year." Target",$data_11));
...
/* ;
	...
	$serie2->addPoint(new Point("06-01", 280));
	 #$serie2->addPoint(new Point($year." Actual", $data_21));
/* 
	...
	*/
	...
	$dataSet->addSerie("Targets", $serie1);
	$dataSet->addSerie("Actuals", $serie2);
