...
$data="<table width='100%' border='0'>
  ...
  <tr class='evenrow2'>
    <td>&nbsp;</td>
	<td>&nbsp;</td>
    <td colspan='3'><strong>Qaurter (Jan - Mar)</strong></td>
...
$data="<fieldset class='evenrow'><table width='660' border='0' cellspacing='0'>
   <tr class='evenrow'>
...
$data.="<fieldset class='evenrow'><table width='700' border='0' cellspacing='1'>
".filter_cumulativeTargetsAgainstActuals()."
  <tr>
    <th scope='col'>&nbsp;</th>
    <th colspan='5' scope='col'><center>CUMMULATIVE SEMI-ANNUAL  TARGETS AGAINST ACTUALS</center></th>

  </tr>
  <tr class='evenrow2' style=''>
    <td class=black2 align='right'>CODE</td>
	<td class=black2>Sub-Activity<img src='' width='200' height='0'></td>
    <td class=black2>Indicator</td>
    <td class=black2>Total Cummulative Targets</td>
    <td class=black2>Total Cummulative Actuals</td>
    <td class=black2>(%)Achieved</td>
 ...
 */
 ...
 #$ccfPPLTA=($row['ccfPercentageProjectLifeAchieved']!=0)?"<td align='right'>".$row['ccfPercentageProjectLifeAchieved']."%</td>":"<td align='right'>0%</td>";
 #$projectlifetarget=($row['projectlifetarget']!='')?"<td align='right'>$row[projectlifetarget]</td>":"<td align='right'>-</td>";
 $totalcummulativetarget=($row['totalcummulativetarget']!='')?"<td align='right'>".number_format($row['totalcummulativetarget'])."</td>":"<td align='right'>-</td>";
 $totalcummulativeactual=($row['totalcummulativeactual']!='')?"<td align='right'>".number_format($row['totalcummulativeactual'])."</td>":"<td align='right'>-</td>";
  $data.="<tr class=$color>
    <td align='right'>".$row['subactivity_code']."</td>
    <td> ".$row['subactivity_name']."</td>
    <td>$row[indicator_name]</td>
...
$data.=" <fieldset class='evenrow'><form name='ccf' id='ccf'><table width='700' border='0' cellspacing='1'>
...
$data.="<fieldset class='evenrow'><table width='660' cellspacing='1' >".filter_annualPhysicalWorkplan()."
            ...
            <tr><td width='' class='evenrow2'>No.</td>
              ...
              <td colspan='2' class='evenrow2'>Subactivity<img src='' width='200' height='0'> </td>
...
<td align=right>".$n++."</td>
			...
			".$quarter3."
			".$quarter4."
			<td align=right  colspan=2><strong>$row[ptotal]</strong></td>
...
$data="<fieldset class='evenrow'><table   border='0' cellspacing='1'>".filter_ProgramResultsProjectLifeFinancialTargets()."
	<th scope='col'>NO</th>
	
	<th scope='col'>output<img src='' width='200' height='0'> </th>
    <th scope='col'>Sub-component</th>
	<th scope='col'><b align='right'>Budget IN '000' DKK</b<img src='' width='50' height='0'> </th>
    <th scope='col'><b align='right'>Budget IN '000' UGX</b><img src='' width='100' height='0'> </th>
  ...
  $data.="<tr class=$color>
	...
	<td align='right' ><b>".number_format($row['ugx'])."</b></td>
...
$data.="<fieldset class='evenrow'><table width='600' border='0' cellspacing='0'>
".filter_annualPhysicalMonitoring()."
<tr><th scope='col' colspan='10' align='center'><B><center>Physical Monitoring Results For ".$_SESSION['PMyear']."</center></b> </th></tr>
  <tr>
    <th scope='col'>NO</th>
...
<table width="870" border="0" align="center" id="content_" >
  ...
  <tr>
	...
	xajax_view_annualFinancialWorkplan('','','','');
			...
			else if($linkvar=="Annual Workplan"){?>
			...
			<?php 
			} else if($linkvar=="Annual Monitoring"){
