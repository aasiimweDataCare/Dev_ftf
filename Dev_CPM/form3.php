...
function view_form3($program_id,$project_id){
$obj=new xajaxResponse();
if($_SESSION['user_id']==''){
$obj->redirect('index.php');
return $obj;
  ...
  <tr class=''>
    ...
    <th colspan='10' ><center>In case of any training conducted, complete the Table</center></th>
        ...
        $data.="<tr class='evenrow3'>
          ...
          $data.="<td><select name='district' id='distict' style='width:100px;'>
          <option value=''>-select-</option>";
		  $data.=QueryManager::DistrictFilter($program_id,$project_id);
		  $data.="</select>";
                  $data.="</td>";
                  
        
          $data.="<td><strong>Subcounty:</strong></td>";
          $data.="<td><select name='subcounty' style='width:100px;'>
          <option value=''>-select-</option>";
		 ...
		 $data.=QueryManager::ParishFilter($program_id,$project_id);
          ...
          <td style='width:100px;'><input name='village' id='village'  type='text' id='trainer' size='50' />
          </td></tr>";
   ...
   $data.="<tr>
          ...
          <div align='left'><strong>Date of training:</strong></div></td>
            ...
            <input name='trainingDate' type='text'  size='15px' value='' id='trainingDate' readonly='readonly' />
...
#$obj->alert($_SESSION['parishCode']);
$data="<form action=\"".$PHP_SELF."\" name='projects' id='projects' method='post'>
<table width='800' cellspacing='0' id='report'>".filter_training();
 ...
 // $data.=selectandDelete_all(10,'edit_training','projects','delete_training','training_id','training_id','tbl_training','delete_data',7)."</tr>
  ...
  $classCode=25;$x=1;
		//$sql=QueryManager::ViewTraining($program_id,$project_id);
  ...
  $query_program=Execute($sql)or die(http("PR-3346"));
 	 ...
 	 $div=$rowP['program_name'].$rowP['program_id'];
    	...
    	//$data.=Backgroundstyle($x)."<td><strong>".$rowP['program_id']."</strong></td>
		$color=$n%2==1?"evenrow":"white1";
...
//"".noRecordsFound($query,11).

 //$data.=selectandDelete_all(10,'edit_training','projects','delete_training','training_id','training_id','tbl_training','delete_data',7)
 $data.="</tr></table></form>";
