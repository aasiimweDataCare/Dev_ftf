...
$query=mysql_query("insert into tbl_user(name,username,password,role,subcomponent,program_id,org_code,district,usergroup,project_id,country)values('".$name."','".$username."','".md5($password)."','".$role."','".$subcomponent."','".$program_code."','".$organization."','".$district."','".$usergroup."','".$project."','".$country."')")or die(http(0704));
