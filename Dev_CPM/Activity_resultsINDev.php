 							...
 							$data.="<tr class=$color ".$events2.">
									...
									$data.="</tr>";
                                                                        ...
                                                                        //======================================================================================
                                                                            ...
                                                                            $events3="onmouseover=\"this.style.backgroundColor='#006db9'\" onmouseout=\"this.style.backgroundColor=''\"";
                                                                        switch($inc){
                                                                                //Indicator 1
                                                                            ...
                                                                            $data.="<tr class=$color ".$events2.">";
                                                                              ...
                                                                              <td colspan=''><div align='right'><strong>Beans</strong></div></td>
                                                                              <td colspan='2'>1</td>
                                                                              <td>2</td><td>3</td>";
                                                                              foreach ($colorArray as $var) {
																							 
																				            $data.="<td style='".$var."' ".$events3."  align='right'>4</td>";
                                                                                            
                                                                                            
                                                                                        }
																			$data.="<td>LOA Targets</td>
																					<td>LOA Actuals</td>
																					<td>% Achieved</td>";
                                                                            $data.="</tr>";
                                                                            ...
                                                                            $data.="<tr class=$color ".$events2.">
																			  <td colspan='6'></td>
																			  <td colspan=''>Coffee</td>
																			  <td colspan='2'>1</td>
																			  <td>2</td>
																			  <td>3</td>";
																			  
																			  /* $data.="<td align='right'>5</td>";
																			  $data.="<td align='right'>4</td>";
																			  $data.="<td align='right'>5</td>";
																			  $data.="<td align='right'>4</td>";
																			  $data.="<td align='right'>5</td>";
																			  $data.="<td align='right'>4</td>";
																			  $data.="<td colspan='1' align='right'>5</td>";
																			  $data.="<td align='right'>4</td>";
																			  $data.="<td colspan='1' align='right'>5</td>";
																			  $data.="<td align='right'>4</td>";
																			  $data.="<td colspan='1' align='right'>5</td>";
																			  ...
																			  foreach ($colorArray as $var) {
																							$data.="<td style='".$var."' ".$events3."  align='right'>5</td>"; 
																				            $data.="<td style='".$var."' ".$events3."  align='right'>4</td>";
                                                                                         }
                                                                            ...
                                                                            $data.="<tr class=$color ".$events2.">";
                                                                              $data.="<td colspan='6'></td>
                                                                              <td colspan=''><div align='right'><strong>Maize</strong></div></td>
                                                                              <td colspan='2'>1</td>
                                                                              <td>2</td><td>3</td>";
                                                                              foreach ($colorArray as $var) {
                                                                                            $data.="<td style='".$var."' ".$events3."  align='right'>4</td>";
