    ...
    <body>
        ...
        <form id = "testForm1" onsubmit = "return false;">
            <p>
                ...
                <input type='button' class='formButton2'value = 'xml' onclick = '<?php $callXmlResponse->printScript(); ?>' />

                <input type='button' class='formButton2'value = 'text' onclick = '<?php $callTextResponse->printScript(); ?>' />
            </p>
        </form>
