...
function loadingIconFormSix(Component) {
    $("#dvLoading").show(function(){
		...
		if(Component=='go_to_form6_web_form')xajax_view_form6_web_form('','','','',1,1000);
		if(Component=='go_to_form6_survey_one')xajax_view_form6_survey_one('','','','','',1,1000);
		if(Component=='go_to_form6_survey_two')xajax_view_form6_survey_two('','','','','',1,1000);
		if(Component=='go_to_form6_survey_three')xajax_view_form6_survey_three('','','','','',1,1000);		
		if(Component=='go_to_form6_survey_four')xajax_view_form6_survey_four('','','','','',1,1000);
		if(Component=='go_to_form6_survey_five')xajax_view_form6_survey_five('','','','','',1,1000);		
		if(Component=='go_to_form6_survey_six')xajax_view_form6_survey_six('','','','','',1,1000);
