...
<table width="660" border="0" align="center" id="content_" >
  <tr>
    <td colspan="2" valign="top"><img src="images/print_header.gif" alt="print version">
      </td>
        </tr>
  <tr>
 
    <td width="700" valign="top"  ><div id="title">
  <?php   $action="Dashboard";
       $linkvar=" View Dashboard";
     # title($linkvar,$action); ?>
    </div>
	<div id='bodyDisplay' style="float:inherit;"> <?php
